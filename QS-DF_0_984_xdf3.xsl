...
<xsl:stylesheet
	...
	<xsl:param name="DebugMode" select="'0'"/>
		...
		<xsl:choose>
			<xsl:when test="$DateiOutput ='1'">
				...
				<xsl:variable name="OutputDateiname">
					<xsl:choose>
						<xsl:when test="name(/*) ='xdf3:xdatenfelder.stammdatenschema.0102'">Bericht_<xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:id"/><xsl:if test="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version">V<xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version"/></xsl:if>.html</xsl:when>
				...
				<head>
						<xsl:choose>
							<xsl:when test="name(/*) ='xdf3:xdatenfelder.stammdatenschema.0102'">
								<title>Details zum Datenschema <xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:id"/><xsl:if test="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version"> Version <xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version"/></xsl:if></title>
							</xsl:when>
							<xsl:otherwise>
					...
					<xsl:if test="$Navigation = '1' and $Statistik !='2'">
						<div id="fixiert" class="Navigation">
							<xsl:if test="$JavaScript = '1'">
								<p align="right"><a href="#" title="Schlie�e das Navigationsfenster" onclick="VersteckeNavigation(); return false;">&#10006;</a></p>
							</xsl:if>
							<h2>Navigation</h2>
							<xsl:choose>
								<xsl:when test="name(/*) ='xdf3:xdatenfelder.stammdatenschema.0102'">
									...
									<p><a href="#SchemaDetails">Details zu den Datenschemata</a></p>
							...
							<xsl:when test="name(/*) ='xdf3:xdatenfelder.stammdatenschema.0102'">
								...
								<h1>
									<xsl:choose>
										<xsl:when test="$Meldungen = '1'">
											Qualit�tsbericht Datenschema <xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:id"/><xsl:if test="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version">&#160;Version&#160;<xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version"/></xsl:if>
										</xsl:when>
										<xsl:otherwise>
											�bersicht Datenschema <xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:id"/><xsl:if test="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version">&#160;Version&#160;<xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version"/></xsl:if>
										</xsl:otherwise>
									</xsl:choose>
								</h1>
								<xsl:if test="$Statistik != '2'">
									...
									<div id="Zusammenfassungsbereich">
										<xsl:if test="$MeldungsFazit = '1' and $Meldungen = '1' and $JavaScript = '1'">
											<h2><a name="Zusammenfassung"/>QS-Zusammenfassung des Datenschemas <xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:id"/><xsl:if test="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version">&#160;Version&#160;<xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version"/></xsl:if></h2>
	...
	<xsl:template name="statistik">
		...
		<xsl:choose>
			<xsl:when test="$Statistik = '2'">
					<h2><a name="Statistik"/>Statistik zum Datenschema <xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:id"/><xsl:if test="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version">&#160;Version&#160;<xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version"/></xsl:if></h2>
					...
					<xsl:if test="$StatistikZustandsinfos = '1'"><p><a href="#StatistikZustandsinfos">Liste der Elemente ohne Statussetzenden oder mit Status inaktiv</a></p></xsl:if>
			</xsl:when>
			<xsl:otherwise>
					<h2><a name="Statistik"/>Statistik zum Datenschema <xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:id"/><xsl:if test="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version">&#160;Version&#160;<xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version"/></xsl:if></h2>
			</xsl:otherwise>
		...
		<h3><a name="StatistikKennzahlen"/>�bersicht der Kennzahlen<br/></h3>
				...
				<tbody>
					...
					<xsl:for-each-group select="//xdf3:datenfeld | //xdf3:datenfeldgruppe" group-by="concat(xdf3:identifikation/xdf3:id,xdf3:identifikation/xdf3:version)">
						...
						<xsl:if test="$DebugMode = '3' or $DebugMode = '4'">
							<xsl:message>
								-------- <xsl:value-of select="./xdf3:identifikation/xdf3:id"/><xsl:if test="./xdf3:identifikation/xdf3:version">V<xsl:value-of select="./xdf3:identifikation/xdf3:version"/></xsl:if> --------
							</xsl:message>
						</xsl:if>
								...
								<td>
									<xsl:choose>
										<xsl:when test="$Statistik = '2' or empty(./xdf3:identifikation/xdf3:id)">
											<xsl:value-of select="./xdf3:identifikation/xdf3:id"/><xsl:if test="$ToolAufruf = '1'">&#160;&#160;<xsl:element name="a"><xsl:attribute name="href"><xsl:value-of select="$ToolPfadPrefix"/><xsl:value-of select="./xdf3:identifikation/xdf3:id"/><xsl:if test="./xdf3:identifikation/xdf3:version">V<xsl:value-of select="./xdf3:identifikation/xdf3:version"/></xsl:if><xsl:value-of select="$ToolPfadPostfix"/></xsl:attribute><xsl:attribute name="target">FIMTool</xsl:attribute><xsl:attribute name="title">Springe in den Datenfeldeditor (man muss vorher angemeldet sein).</xsl:attribute>&#8658;</xsl:element>&#160;&#160;&#160;&#160;</xsl:if>
										</xsl:when>
										<xsl:otherwise>
											<xsl:choose>
												<xsl:when test="$InterneLinks = '1'">
		...
		<xsl:if test="$StatistikZustandsinfos = '1'">
			...
			<xsl:choose>
				<xsl:when test="$Statistik = '2'">
					<h3><a name="StatistikZustandsinfos"/>Baukastenelemente ohne Statussetzenden oder Status inaktiv&#160;<a href="#Statistik" title="nach oben">&#8593;</a><br/></h3>
				</xsl:when>
				<xsl:otherwise>
					<h3><a name="StatistikZustandsinfos"/>Baukastenelemente ohne Statussetzenden oder Status inaktiv<br/></h3>
				</xsl:otherwise>
			</xsl:choose>
		...
		<xsl:if test="$DebugMode = '1' or $DebugMode = '2' or $DebugMode = '3' or $DebugMode = '4'">
			<xsl:message>
				++++ stammdatenschemaeinzeln ++++
					...
					<h2>
						<a name="SchemaDetails"/>Details zum Datenschema <xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:id"/><xsl:if test="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version">&#160;Version&#160;<xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version"/></xsl:if>
					</h2>
					<table style="page-break-after:always">
						<thead>
							<tr>
				...
				-------- <xsl:value-of select="$Element/xdf3:identifikation/xdf3:id"/><xsl:if test="$Element/xdf3:identifikation/xdf3:version">V<xsl:value-of select="$Element/xdf3:identifikation/xdf3:version"/></xsl:if> --------
										...
										<tr>
											...
											<xsl:choose>
												...
												<td class="SDSName">
														<xsl:if test="$Meldungen = '1'"><div class="Fehler E1002">Fehler!! E1002: Der Name muss bef�llt werden.</div></xsl:if>
													</td>
												</xsl:when>
												<xsl:otherwise>
													...
													<xsl:when test="fn:count($Element/xdf3:bezug) = 0">
														<xsl:choose>
															...
															<xsl:when test="$Element/xdf3:schemaelementart/code/text() = 'HAR'">
																<xsl:if test="$Meldungen = '1'"><div class="Warnung W1001">Warnung!! W1001: Der Bezug zur Handlungsgrundlage sollte bei Elementen mit der Strukturelementart "harmonisiert" m�glichst nicht leer sein.</div></xsl:if>
															</xsl:when>
															<xsl:otherwise>
															</xsl:otherwise>
														</xsl:choose>
											...
											<xsl:choose> 
												<xsl:when test="empty($Element/xdf3:statusGesetztDurch/text()) and $VersionsHinweise ='1'">
													<td>
														...
														<xsl:if test="$Meldungen = '1'"><div class="Hinweis">Hinweis!! Das Feld "Status gesetzt durch" darf zur Versionierung oder Ver�ffentlichung nicht leer sein.</div></xsl:if>
													</td>
												</xsl:when>
												<xsl:otherwise>
													<td>
										...
										<tr>
											...
											<td>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:if test="$Meldungen = '1'"><div class="Fehler E1007">Fehler!! E1007: Es ist kein Dokumentsteckbrief zugeordnet.</div></xsl:if>
													</xsl:otherwise>
												</xsl:choose>
											</td>
										</tr>
		...
		<xsl:if test="$DebugMode = '1' or $DebugMode = '2' or $DebugMode = '3' or $DebugMode = '4'">
			<xsl:message>
				++++ listeelementedetail ++++
					...
					<h2><br/></h2>
					<h2>
						<a name="ElementDetails"/>Details zu den Baukastenelementen des Datenschemas <xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:id"/><xsl:if test="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version"> Version <xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version"/></xsl:if>
					</h2>
					<table style="page-break-after:always">
						<thead>
							<tr>
											...
											<tr>
												...
												<xsl:choose>
													<xsl:when test="empty($Element/xdf3:identifikation/xdf3:id/text())">
														<td class="ElementID">
															<xsl:if test="$Meldungen = '1'"><div class="Fehler E1038">Fehler!! E1038: Die ID muss bef�llt werden.</div></xsl:if>
														</td>
													</xsl:when>
													<xsl:otherwise>
														<td class="ElementID">
												...
												<xsl:choose>
													<xsl:when test="$Element/xdf3:schemaelementart/code/text() = 'ABS' and $AbstraktWarnung ='1'">
														<td>
															...
															<xsl:if test="$Meldungen = '1'"><div class="Fehler E1014">Fehler!! E1014: Datenfelder d�rfen nicht die Strukturelementart "abstrakt" haben.</div></xsl:if>
														</td>
													</xsl:when>
													<xsl:otherwise>
														<td>
													...
													<xsl:when test="$Element/xdf3:feldart/code/text() = 'select'">
														<xsl:choose>
															...
															<xsl:when test="$Element/xdf3:datentyp/code/text() = 'int'">
																<td>
																	<xsl:apply-templates select="$Element/xdf3:datentyp"/>
																	<xsl:if test="$Meldungen = '1'"><div class="Warnung W1008">Warnung!! W1008: Bei Auswahlfelder ist der Datentyp i.d.R. vom Typ 'text'.</div></xsl:if>
																</td>
															</xsl:when>
															<xsl:otherwise>
																<td>
																	<xsl:apply-templates select="$Element/xdf3:datentyp"/>
																	<xsl:if test="$Meldungen = '1'"><div class="Fehler E1011">Fehler!! E1011: Bei Datenfeldern mit der Feldart "Auswahlfeld" sollte der Datentyp "Text" sein - in seltenen F�llen "Ganzzahl".</div></xsl:if>
																</td>
															</xsl:otherwise>
														</xsl:choose>
													</xsl:when>
											...
											<tr>
												...
												<xsl:choose>
													<xsl:when test="$Element/xdf3:praezisierung">
														...
														<xsl:variable name="minLength"><xsl:value-of select="$Element/xdf3:praezisierung/@minLength"/></xsl:variable>
														<xsl:variable name="maxLength"><xsl:value-of select="$Element/xdf3:praezisierung/@maxLength"/></xsl:variable>
														...
														<xsl:choose>
																		...
																		<xsl:choose>
																			<xsl:when test="$minLength != '' or $maxLength != ''">
																				<td>
																					...
																					<xsl:if test="$Meldungen = '1'"><div class="Fehler E1012">Fehler!! E1012: Bei Datenfeldern mit der Feldart "Auswahlfeld" oder "Statisches, read-only Feld" sollten weder die minimale noch die maximale Feldl�nge angegeben werden.</div></xsl:if>
																				</td>
																			</xsl:when>
																			<xsl:otherwise>
																				<td>
																		...
																		<xsl:choose>
																			...
																			<xsl:otherwise>
																				<td>
																					...
																					<xsl:if test="$Meldungen = '1'"><div class="Warnung W1002">Warnung!! W1002: Bei Eingabedatenfeldern mit dem Datentyp 'text' oder 'text_latin' sollten, wenn m�glich, die minimale und maximale Feldl�nge angegeben werden.</div></xsl:if>
																				</td>
																			</xsl:otherwise>
																		</xsl:choose>
																	</xsl:otherwise>
															...
															<xsl:when test="$minLength != '' or $maxLength != ''">
																<td>
																	...
																	<xsl:if test="$Meldungen = '1'"><div class="Fehler E1015">Fehler!! E1015: Eine Feldl�nge darf nur bei einem Datenfeld mit dem Datentyp "Text" angegeben werden.</div></xsl:if>
																</td>
															</xsl:when>
															<xsl:otherwise>
																<td></td>
											...
											<tr>
												...
												<xsl:choose>
													<xsl:when test="$Element/xdf3:praezisierung">
														...
														<xsl:variable name="minValue"><xsl:value-of select="$Element/xdf3:praezisierung/@minValue"/></xsl:variable>
														<xsl:variable name="maxValue"><xsl:value-of select="$Element/xdf3:praezisierung/@maxValue"/></xsl:variable>
																...
																<xsl:choose>
																	<xsl:when test="$minValue != '' or $maxValue != ''">
																		<td>
																			...
																			<xsl:if test="$Meldungen = '1'"><div class="Fehler E1016">Fehler!! E1016: Ein Wertebereich darf nur bei einem Datenfeld mit einem nummerischen Datentyp (Flie�kommazahl, Ganzzahl, W�hrungswert) angegeben werden.</div></xsl:if>
																		</td>
																	</xsl:when>
																	<xsl:otherwise>
																		<td>
													...
													<xsl:otherwise>
														<xsl:choose>
															<xsl:when test="$Element/xdf3:datentyp/code/text() = 'num' or $Element/xdf3:datentyp/code/text() = 'num_int' or $Element/xdf3:datentyp/code/text() = 'num_currency'">
																<td>
																	<xsl:if test="$Meldungen = '1'"><div class="Warnung W1003">Warnung!! W1003: Bei Datenfeldern mit dem Datentyp num, num_int oder num_currency sollte, wenn m�glich, ein Wertebereich angegeben werden.</div></xsl:if>
																</td>
															</xsl:when>
															<xsl:otherwise>
																<td></td>
											...
											<tr>
												<xsl:choose>
															...
															<xsl:choose>
																<xsl:when test="$InterneLinks = '1'">
																	<xsl:element name="a">
																		...
																		<xsl:value-of select="$Element/xdf3:codelisteReferenz/xdf3:canonicalIdentification"/><xsl:if test="$Element/xdf3:codelisteReferenz/xdf3:version">_<xsl:value-of select="$Element/xdf3:codelisteReferenz/xdf3:version"/></xsl:if>
																	</xsl:element>
																</xsl:when>
																<xsl:otherwise>
																	<xsl:value-of select="$Element/xdf3:codelisteReferenz/xdf3:canonicalIdentification"/><xsl:if test="$Element/xdf3:codelisteReferenz/xdf3:version">_<xsl:value-of select="$Element/xdf3:codelisteReferenz/xdf3:version"/></xsl:if>
													...
													<xsl:when test="$Element/xdf3:feldart/code/text() = 'select' and not($Element/xdf3:codelisteReferenz or $Element/xdf3:werte)">
														<td>
															<xsl:if test="$Meldungen = '1'"><div class="Fehler E1018">Fehler!! E1018: Wenn ein Datenfeld die Feldart "Auswahlfeld" hat, muss eine Codeliste oder Werteliste zugeordnet sein.</div></xsl:if>
														</td>
													</xsl:when>
											...
											<tr>
												...
												<xsl:choose>
													<xsl:when test="$Element/xdf3:feldart/code/text() = 'label' and empty($Element/xdf3:inhalt/text())">
														<td>
															<xsl:if test="$Meldungen = '1'"><div class="Warnung W1009">Warnung!! W1009: Bei einem statischen Element mit der Feldart label wird i.d.R. das Datenfeld Inhalt mit einem Text bef�llt.</div></xsl:if>
														</td>
													</xsl:when>
													<xsl:otherwise>
														<td>
											...
											<tr>
												...
												<xsl:choose>
													<xsl:when test="empty($Element/xdf3:bezeichnungEingabe/text())">
														<td>
															<xsl:if test="$Meldungen = '1'"><div class="Fehler E1009">Fehler!! E1009: Die Bezeichnung Eingabe muss bef�llt werden.</div></xsl:if>
														</td>
													</xsl:when>
													<xsl:otherwise>
														<td>
											...
											<tr>
												...
												<xsl:choose>
													<xsl:when test="empty($Element/xdf3:bezeichnungAusgabe/text())">
														<td>
															<xsl:if test="$Meldungen = '1'"><div class="Fehler E1010">Fehler!! E1010: Die Bezeichnung Ausgabe muss bef�llt werden.</div></xsl:if>
														</td>
													</xsl:when>
													<xsl:otherwise>
														<td>
																				...
																				<xsl:variable name="regellistedoppelte">
																					<xdf3:enthaltenebaukastenelemente>
																						<xsl:analyze-string regex="[F|G]\d{{11}}" select="./xdf3:freitextRegel">
																							<xsl:matching-substring>
																								<xdf3:elementid><xsl:value-of select="."/></xdf3:elementid>
																							</xsl:matching-substring>
																							<xsl:non-matching-substring>
																							</xsl:non-matching-substring>
																						</xsl:analyze-string>
																...
																<table>
																	...
																	<tbody>
																		...
																		<xsl:for-each select="$Element/xdf3:struktur">
																			...
																			<xsl:variable name="VergleichsElement"><xsl:value-of select="./xdf3:enthaelt/*/xdf3:identifikation/xdf3:id"/></xsl:variable>
																				...
																				<tr>
																					...
																					<xsl:choose> 
																						<xsl:when test="empty(./xdf3:enthaelt/*/xdf3:identifikation/xdf3:version/text()) and $VersionsHinweise ='1'">
																							<td>
																								...
																								<xsl:if test="$Meldungen = '1'"><div class="Hinweis">Hinweis!! Zur Versionierung und Ver�ffentlichung m�ssen alle verwendete Unterelemente versioniert sein.</div></xsl:if>
																							</td>
																						</xsl:when>
																						<xsl:otherwise>
																							<td>
																					...
																					<xsl:choose>
																						<xsl:when test="./xdf3:enthaelt/*/xdf3:schemaelementart/code/text() = 'ABS' and $AbstraktWarnung = '1'">
																							<td>
																								...
																								<xsl:if test="$Meldungen = '1'"><div class="Fehler E1013">Fehler!! E1013: Innerhalb von Datenschemata und Datenfeldgruppen d�rfen nur Elemente mit der Strukturelementart harmonisiert oder rechtnormgebunden verwendet werden.</div></xsl:if>
																							</td>
																						</xsl:when>
																						<xsl:otherwise>
																							<td>
																					...
																					<xsl:choose>
																						<xsl:when test="./xdf3:enthaelt/*/xdf3:freigabestatus/code/text() = '7'">
																							<td>
																								...
																								<xsl:if test="$Meldungen = '1'"><div class="Warnung W1016">Warnung!! W1016: Baukastenelemente im Status 'inaktiv' sollten nur in Ausnahmef�llen verwendet werden.</div></xsl:if>
																							</td>
																						</xsl:when>
																						<xsl:otherwise>
																							<td>
																					...
																					<xsl:choose>
																						<xsl:when test="./xdf3:anzahl='0:0'">
																							<td>
																								...
																								<xsl:if test="$Meldungen = '1'"><div class="Fehler E1021">Fehler!! E1021: Es ist keine Multiplizit�t angegeben.</div></xsl:if>
																							</td>
																						</xsl:when>
																						<xsl:otherwise>
																							<td>
																					...
																					<xsl:choose>
																						<xsl:when test="$Strukturelementart ='RNG' and (./xdf3:enthaelt/*/xdf3:schemaelementart/code/text() = 'ABS' or ./xdf3:enthaelt/*/xdf3:schemaelementart/code/text() = 'HAR') and empty(./xdf3:bezug/text())">
																							<td>
																								<xsl:if test="$Meldungen = '1'"><div class="Fehler E1022">Fehler!! E1022: Bei Verwendung von Elementen mit der Strukturelementart "harmonisiert" innerhalb von Datenfeldgruppen mit der Strukturelementart "rechtsnormgebunden" muss zur Multiplizit�t ein Bezug zu einer Handlungsgrundlage angegeben werden.</div></xsl:if>
																							</td>
																						</xsl:when>
																						<xsl:otherwise>
																							<td>
		...
		<xsl:if test="$DebugMode = '1' or $DebugMode = '2' or $DebugMode = '3' or $DebugMode = '4'">
			<xsl:message>
				++++ listeregeldetails ++++
					...
					<h2><br/></h2>
					<h2>
						<a name="RegelDetails"/>Details zu den Regeln des Datenschemas <xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:id"/><xsl:if test="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version"> Version <xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version"/></xsl:if>
					</h2>
					<table style="page-break-after:always">
						<thead>
							<tr>
				...
				-------- <xsl:value-of select="$Element/xdf3:identifikation/xdf3:id"/><xsl:if test="$Element/xdf3:identifikation/xdf3:version">V<xsl:value-of select="$Element/xdf3:identifikation/xdf3:version"/></xsl:if> --------
								...
								<tr>
									...
									<xsl:choose>
										...
										<td>
												<xsl:if test="$Meldungen = '1'"><div class="Fehler E1024">Fehler!! E1024: Die Freitextregel muss bef�llt sein.</div></xsl:if>
											</td>
										</xsl:when>
										<xsl:otherwise>
											<td>
									...
									<xsl:choose> 
										<xsl:when test="empty($Element/xdf3:fachlicherErsteller/text()) and $VersionsHinweise ='1'">
											<td>
												...
												<xsl:if test="$Meldungen = '1'"><div class="Hinweis">Hinweis!! Das Feld "Fachlicher Ersteller" darf zur Versionierung oder Ver�ffentlichung nicht leer sein.</div></xsl:if>
											</td>
										</xsl:when>
										<xsl:otherwise>
											<td>
		...
		<xsl:if test="$DebugMode = '1' or $DebugMode = '2' or $DebugMode = '3' or $DebugMode = '4'">
			<xsl:message>
				++++ listecodelistendetails ++++
					...
					<h2><br/></h2>
					<h2>
						<a name="CodelisteDetails"/>Details zu den Codelisten des Datenschemas <xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:id"/><xsl:if test="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version"> Version <xsl:value-of select="/*/xdf3:stammdatenschema/xdf3:identifikation/xdf3:version"/></xsl:if>
					</h2>
					<table style="page-break-after:always">
						<thead>
							<tr>
			...
			<xsl:message>
				-------- <xsl:value-of select="$Element/xdf3:identifikation/xdf3:id"/> --------
								...
								<xsl:if test="$CodelistenInhalt = '1' and $Element/xdf3:version and substring($Element/xdf3:canonicalIdentification/text(),1,4) = 'urn:'">
									...
									<xsl:variable name="NormalisierteVersion"><xsl:if test="$Element/xdf3:version">_<xsl:value-of select="$Element/xdf3:version"/></xsl:if></xsl:variable>
									...
									<xsl:choose>
										...
										<xsl:otherwise>
											<tr>
												<td>Kurzname</td>
												<td>
													<b><xsl:value-of select="$CodelisteInhalt/*/gc:Identification/gc:ShortName"/>
													<xsl:value-of select="$CodelisteInhalt/*/Identification/ShortName"/></b>
												</td>
											</tr>
											<tr>
												<td>Langname</td>
...
-->
		...
		<xsl:if test="$DebugMode = '4'">
			<xsl:message>
				++++++++++++++++ unterelemente ++++++++++++++++
														...
														<xsl:variable name="XORGruppe"><xsl:choose><xsl:when test="$Element/xdf3:art/code = 'X'">1</xsl:when><xsl:otherwise>0</xsl:otherwise></xsl:choose></xsl:variable>
																...
																<tr>
																	...
																	<xsl:choose>
																		<xsl:when test="./xdf3:enthaelt/*/xdf3:schemaelementart/code/text() = 'ABS' and $Tiefe = 1 and$AbstraktWarnung ='1'">
																			<td>
																				<xsl:apply-templates select="./xdf3:enthaelt/*/xdf3:schemaelementart"/>																				<xsl:if test="$Meldungen = '1'"><div class="Fehler E1013">Fehler!! E1013: Innerhalb von Datenschemata und Datenfeldgruppen d�rfen nur Elemente mit der Strukturelementart harmonisiert oder rechtnormgebunden verwendet werden.</div></xsl:if>
																			</td>
																		</xsl:when>
																		<xsl:otherwise>
																			<td>
																				<xsl:apply-templates select="./xdf3:enthaelt/*/xdf3:schemaelementart"/>																			</td>
																		</xsl:otherwise>
																	</xsl:choose>
																	<xsl:choose>
																	...
																	<xsl:choose>
																		<xsl:when test="./xdf3:anzahl='0:0'and $Tiefe = 1">
																			<td>
																				<xsl:value-of select="./xdf3:anzahl"/>
																				<xsl:if test="$Meldungen = '1'"><div class="Fehler E1021">Fehler!! E1021: Es ist keine Multiplizit�t angegeben.</div></xsl:if>
																			</td>
																	...
																	<xsl:choose>
																		<xsl:when test="$Strukturelementart ='RNG' and (./xdf3:enthaelt/*/xdf3:schemaelementart/code/text() = 'ABS' or ./xdf3:enthaelt/*/xdf3:schemaelementart/code/text() = 'HAR') and empty(./xdf3:bezug/text())and $Tiefe = 1">
																			<td>
																				<xsl:if test="$Meldungen = '1'"><div class="Fehler E1022">Fehler!! E1022: Bei Verwendung von Elementen mit der Strukturelementart "abstrakt" oder "harmonisiert" innerhalb von Datenfeldgruppen mit der Strukturelementart "rechtsnormgebunden" muss zur Multiplizit�t ein Bezug zu einer Handlungsgrundlage angegeben werden.</div></xsl:if>
																			</td>
																		</xsl:when>
																		<xsl:when test="$Strukturelementart ='SDS' and (./xdf3:enthaelt/*/xdf3:schemaelementart/code/text() = 'ABS' or ./xdf3:enthaelt/*/xdf3:schemaelementart/code/text() = 'HAR') and empty(./xdf3:bezug/text())and $Tiefe = 1">
																			<td>
																				<xsl:if test="$Meldungen = '1'"><div class="Fehler E1022">Fehler!! E1022: Bei Verwendung von Elementen mit der Strukturelementart "abstrakt" oder "harmonisiert" auf oberster Ebene eines Datenschemas muss zur Multiplizit�t ein Bezug zu einer Handlungsgrundlage angegeben werden.</div></xsl:if>
																			</td>
																		</xsl:when>
																		<xsl:otherwise>
																			<td>
	...
	<xsl:template match="xdf3:datentyp">
		<xsl:choose>
			...
			<xsl:when test="./code/text() = 'num'">Flie�kommazahl</xsl:when>
			<xsl:when test="./code/text() = 'num_int'">Ganzzahl</xsl:when>
			<xsl:when test="./code/text() = 'num_currency'">W�hrungswert</xsl:when>
	...
	<xsl:template match="xdf3:praedikat">
		<xsl:choose>
			...
			<xsl:otherwise><xsl:if test="$Meldungen = '1'"><div class="Fehler E1029">Fehler!! E1029: Unbekannte Relationsart</div></xsl:if></xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template match="xdf3:vorbefuellung">
		<xsl:choose>
			...
			<xsl:otherwise><xsl:if test="$Meldungen = '1'"><div class="Fehler E1030">Fehler!! E1030: Unbekannte Vorbef�llungsart</div></xsl:if></xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template match="xdf3:ableitungsmodifikationenStruktur">
		<xsl:choose>
			...
			<xsl:otherwise><xsl:if test="$Meldungen = '1'"><div class="Fehler E1033">Fehler!! E1033: Unbekannte �nderbarkeit der Struktur</div></xsl:if></xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template match="xdf3:ableitungsmodifikationenRepraesentation">
		<xsl:choose>
			...
			<xsl:otherwise><xsl:if test="$Meldungen = '1'"><div class="Fehler E1034">Fehler!! E1034: Unbekannte �nderbarkeit der Repr�sentation</div></xsl:if></xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template match="xdf3:art">
		<xsl:choose>
			...
			<xsl:otherwise><xsl:if test="$Meldungen = '1'"><div class="Fehler E1042">Fehler!! E1042: Unbekannte Gruppenart</div></xsl:if></xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template name="einrueckung">
			...
			<xsl:choose>
				...
				<xsl:when test="$Zaehler = 1 and $XORGruppe = 1">
					<xsl:variable name="Text2"><xsl:value-of select="concat($Text, 'x_')"/></xsl:variable>
					<xsl:call-template name="einrueckung">
						<xsl:with-param name="Tiefe" select="$Tiefe"/>
						<xsl:with-param name="Zaehler" select="$Zaehler + 1"/>
						<xsl:with-param name="Text" select="$Text2"/>
	...
	-->
		...
		<xsl:choose>
			<xsl:when test="$Navigation = '1' and $Statistik != '2'">
				<br/><span class="TrennerNavi"><a style="text-decoration:none;" href="#" title="�ffne das Navigationsfenster" onclick="ZeigeNavigation(); return false;">.</a></span><hr/><br/>
			</xsl:when>
			<xsl:otherwise>
				<br/><hr/><br/>
			</xsl:otherwise>
	...
	<xsl:if test="$JavaScript = '1'">
		...
		<script type="text/javascript">
			...
			<xsl:if test="$MeldungsFazit = '1' and $Meldungen = '1' and $JavaScript = '1'">
				...
				{
					document.getElementById("FehlerListe").insertAdjacentHTML('beforeend', document.querySelectorAll('.E1011').length + " mal E1011: Bei Datenfeldern mit der Feldart 'Auswahlfeld' sollte der Datentyp 'Text' sein - in seltenen F�llen 'Ganzzahl'." + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>");
				}
				if (document.querySelectorAll('.E1012').length != 0)
				{
					document.getElementById("FehlerListe").insertAdjacentHTML('beforeend', document.querySelectorAll('.E1012').length + " mal E1012: Bei Datenfeldern mit der Feldart 'Auswahlfeld' oder 'Statisches, read-only Feld' sollten weder die minimale noch die maximale Feldl�nge angegeben werden." + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>");
				}
				...
				{
					document.getElementById("FehlerListe").insertAdjacentHTML('beforeend', document.querySelectorAll('.E1016').length + " mal E1016: Ein Wertebereich darf nur bei einem Datenfeld mit einem nummerischen Datentyp (Flie�kommazahl, Ganzzahl, W�hrungswert) angegeben werden." + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>");
				}
...
<!--
				...
				{
					document.getElementById("FehlerListe").insertAdjacentHTML('beforeend', document.querySelectorAll('.E1020').length + " mal E1020: Baukastenelemente im Status 'inaktiv' d�rfen nicht verwendet werden." + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>");
				}
-->
...
<!-- nur XDF2 -->
				...
				{
					document.getElementById("WarnungsListe").insertAdjacentHTML('beforeend', document.querySelectorAll('.W1002').length + " mal W1002: Bei Eingabedatenfeldern mit dem Datentyp 'text' oder 'text_latin' sollten, wenn m�glich, die minimale und maximale Feldl�nge angegeben werden." + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>");
				}
				if (document.querySelectorAll('.W1003').length != 0)
				{
					document.getElementById("WarnungsListe").insertAdjacentHTML('beforeend', document.querySelectorAll('.W1003').length + " mal W1003: Bei Datenfeldern mit dem Datentyp 'num', 'num_int' oder 'num_currency' sollte, wenn m�glich, ein Wertebereich angegeben werden." + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>");
				}
<!--				
...
-->
				...
				{
					document.getElementById("WarnungsListe").insertAdjacentHTML('beforeend', document.querySelectorAll('.W1008').length + " mal W1008: Bei Auswahlfelder ist der Datentyp i.d.R. vom Typ 'text'." + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>");
				}
				if (document.querySelectorAll('.W1009').length != 0)
				{
					document.getElementById("WarnungsListe").insertAdjacentHTML('beforeend', document.querySelectorAll('.W1009').length + " mal W1009: Bei einem statischen Element mit der Feldart 'label' wird i.d.R. das Datenfeld Inhalt mit einem Text bef�llt." + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>");
				}
				...
				{
					document.getElementById("WarnungsListe").insertAdjacentHTML('beforeend', document.querySelectorAll('.W1012').length + " mal W1012: Versionierte Baukastenelemente, die nicht verwendet werden, sollten gel�scht werden." + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>");
				}
				if (document.querySelectorAll('.W1013').length != 0)
				{
					document.getElementById("WarnungsListe").insertAdjacentHTML('beforeend', document.querySelectorAll('.W1013').length + " mal W1013: Eine Arbeitsversion, die nicht verwendet wird und keine Versionen hat, sollte gel�scht werden." + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>");
				}
