...
<xsl:stylesheet
	...
	<xsl:param name="MeldungsFazit" select="'0'"/>
		...
		<xsl:choose>
			<xsl:when test="$DateiOutput ='1'">
				...
				<xsl:variable name="OutputDateiname">
					<xsl:choose>
						<xsl:when test="name(/*) ='xdf:xdatenfelder.stammdatenschema.0102'">Bericht_<xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:id"/><xsl:if test="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version">V<xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version"/></xsl:if>.html</xsl:when>
				...
				<head>
						<xsl:choose>
							<xsl:when test="name(/*) ='xdf:xdatenfelder.stammdatenschema.0102'">
								<title>Details zum Datenschema <xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:id"/><xsl:if test="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version"> Version <xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version"/></xsl:if></title>
							</xsl:when>
							...
							<xsl:choose>
								<xsl:when test="name(/*) ='xdf:xdatenfelder.stammdatenschema.0102'">
									<xsl:if test="$MeldungsFazit = '1' and $Meldungen = '1' and $JavaScript = '1'">
										<p id="ZusammenfassungLink"><a href="#Zusammenfassung">QS-Zusammenfassung</a></p>
									</xsl:if>
									...
									<xsl:if test="$Statistik = '1' or $Statistik = '2'">
										<p><a href="#StatistikKennzahlen">Statistikkennzahlen</a></p>
										<xsl:if test="$StatistikVerwendung = '1'">
											<p><a href="#StatistikVerwendung">Verwendung der Elemente</a></p>
										</xsl:if>
										<xsl:if test="$StatistikStrukturart = '1'">
											<p><a href="#StatistikAbstrakte">Abstrakte Elemente</a></p>
											<p><a href="#StatistikHarmonisierte">Harmonisierte Elemente</a></p>
											<p><a href="#StatistikRechtsnormgebundene">Rechtsnormgebundene Elemente</a></p>
										</xsl:if>
										<xsl:if test="$StatistikZustandsinfos = '1'">
											<p><a href="#StatistikZustandsinfos">Zustandsinfos der Elemente</a></p>
										</xsl:if>
									</xsl:if>
									<xsl:if test="$Meldungen = '1' and $JavaScript = '1'">
										<p><br/></p>
										<p id="versteckeLink"><a href="#" onclick="VersteckeMeldungen(); return false;">Blende Meldungen aus</a></p>
										<p id="zeigeLink"><a href="#" onclick="ZeigeMeldungen(); return false;">Zeige Meldungen an</a></p>
									</xsl:if>
								</xsl:when>
								<xsl:when test="name(/*) ='xdf:fim.backup'">
								
									<p class="NavigationsHeadline">Katalog</p>
									<p><a href="#SteckbriefListe">Übersicht der Dokumentsteckbriefe</a></p>
									<p><a href="#SteckbriefDetails">Details zu den Dokumentsteckbriefen</a></p>
									<p class="NavigationsHeadline">Bibliothek</p>
									<p><a href="#StammListe">Übersicht der Datenschemata</a></p>
									<p><a href="#StammDetails">Details zu den Datenschemata</a></p>
									<p class="NavigationsHeadline">Baukasten</p>
									<p><a href="#ElementListe">Übersicht der Elemente</a></p>
									<p><a href="#ElementDetails">Details zu den Baukastenelementen</a></p>
									<p><a href="#RegelDetails">Details zu den Regeln</a></p>
									<p><a href="#CodelisteDetails">Details zu den Codelisten</a></p>
									<xsl:if test="$Statistik = '1'">
										...
										<xsl:if test="$StatistikFehlendeArbeitskopien = '1'">
											<p><a href="#StatistikFehlendeArbeitskopien">Baukastenelemente ohne Arbeitskopie</a></p>
										</xsl:if>
									</xsl:if>
									<xsl:if test="$Meldungen = '1' and $JavaScript = '1'">
										<p><br/></p>
							...
							<xsl:when test="name(/*) ='xdf:xdatenfelder.stammdatenschema.0102'">
								...
								<h1>
									<xsl:choose>
										<xsl:when test="$Meldungen = '1'">
											Qualitätsbericht Datenschema <xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:id"/><xsl:if test="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version">&#160;Version&#160;<xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version"/></xsl:if>
										</xsl:when>
										<xsl:otherwise>
											Übersicht Datenschema <xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:id"/><xsl:if test="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version">&#160;Version&#160;<xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version"/></xsl:if>
										</xsl:otherwise>
									</xsl:choose>
								</h1>
								<xsl:if test="$Statistik != '2'">
									...
									<div id="Zusammenfassungsbereich">
										<xsl:if test="$MeldungsFazit = '1' and $Meldungen = '1' and $JavaScript = '1'">
											<h2><a name="Zusammenfassung"/>QS-Zusammenfassung des Datenschemas <xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:id"/><xsl:if test="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version">&#160;Version&#160;<xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version"/></xsl:if></h2>
								...
								<p>XML: <xsl:value-of select="tokenize($DocumentURI, '/')[last()]"/></p>
							</xsl:when>
							<xsl:when test="name(/*) ='xdf:fim.backup'">
	...
	<xsl:template name="statistikzustammdatenschema">
		...
		<xsl:choose>
			<xsl:when test="$Statistik = '2'">
					<h2><a name="Statistik"/>Statistik zum Datenschema <xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:id"/><xsl:if test="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version">&#160;Version&#160;<xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version"/></xsl:if></h2>
					<xsl:if test="$StatistikVerwendung = '1'"><p><a href="#StatistikVerwendung">Verwendung der Elemente</a></p></xsl:if>
					<xsl:if test="$StatistikStrukturart = '1'"><p>Liste der Elemente: <a href="#StatistikAbstrakte">Abstrakte</a> - <a href="#StatistikHarmonisierte">Harmonisierte</a> - <a href="#StatistikRechtsnormgebundene">Rechtsnormgebundene</a></p></xsl:if>
					<xsl:if test="$StatistikZustandsinfos = '1'"><p><a href="#StatistikZustandsinfos">Liste der Elemente ohne fachlichen Ersteller oder mit Status ungleich aktiv</a></p></xsl:if>
			</xsl:when>
			<xsl:otherwise>
					<h2><a name="Statistik"/>Statistik zum Datenschema <xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:id"/><xsl:if test="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version">&#160;Version&#160;<xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version"/></xsl:if></h2>
			</xsl:otherwise>
		...
		<h3><a name="StatistikKennzahlen"/>Übersicht der Kennzahlen<br/></h3>
			...
			<tbody>
				<xsl:variable name="AnzahlFeldgruppenString">
					<xsl:for-each-group select="//xdf:datenfeldgruppe" group-by="concat(xdf:identifikation/xdf:id,xdf:identifikation/xdf:version)">
						...
						<xsl:if test="fn:position() = 1"><xsl:value-of select="fn:last()"/></xsl:if>
				...
				<xsl:variable name="AnzahlFeldgruppen">
					<xsl:choose>
						...
						<xsl:otherwise><xsl:value-of select="$AnzahlFeldgruppenString"/></xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				...
				<xsl:variable name="AnzahlFeldgruppenAbstrakt">
					<xsl:choose>
						...
						<xsl:otherwise><xsl:value-of select="$AnzahlFeldgruppenAbstraktString"/></xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				...
				<xsl:variable name="AnzahlFeldgruppenHarmonisiert">
					<xsl:choose>
						...
						<xsl:otherwise><xsl:value-of select="$AnzahlFeldgruppenHarmonisiertString"/></xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				...
				<xsl:variable name="AnzahlFeldgruppenRechtsnormgebunden">
					<xsl:choose>
						...
						<xsl:otherwise><xsl:value-of select="$AnzahlFeldgruppenRechtsnormgebundenString"/></xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				...
				<xsl:variable name="AnzahlFelder">
					<xsl:choose>
						...
						<xsl:otherwise><xsl:value-of select="$AnzahlFelderString"/></xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				...
				<xsl:variable name="AnzahlFelderAbstrakt">
					<xsl:choose>
						...
						<xsl:otherwise><xsl:value-of select="$AnzahlFelderAbstraktString"/></xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				...
				<xsl:variable name="AnzahlFelderHarmonisiert">
					<xsl:choose>
						...
						<xsl:otherwise><xsl:value-of select="$AnzahlFelderHarmonisiertString"/></xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				...
				<xsl:variable name="AnzahlFelderRechtsnormgebunden">
					<xsl:choose>
						...
						<xsl:otherwise>><xsl:value-of select="$AnzahlFelderRechtsnormgebundenString"/></xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				...
				<xsl:variable name="AnzahlRegeln">
					<xsl:choose>
						...
						<xsl:otherwise>><xsl:value-of select="$AnzahlRegelnString"/></xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				...
				<xsl:variable name="AnzahlCodelisten">
					<xsl:choose>
						...
						<xsl:otherwise>><xsl:value-of select="$AnzahlCodelistenString"/></xsl:otherwise>
					</xsl:choose>
				</xsl:variable>

				<tr>
					<td>Anzahl Baukastenelemente</td>
					<td><xsl:value-of select="$AnzahlFeldgruppen + $AnzahlFelder"/></td>
				</tr>
				<tr>
					<td>&#160;&#160;Anzahl Datenfeldgruppen</td>
					<td><xsl:value-of select="$AnzahlFeldgruppen"/>, davon abstrakt: <xsl:value-of select="$AnzahlFeldgruppenAbstrakt"/>, harmonisiert: <xsl:value-of select="$AnzahlFeldgruppenHarmonisiert"/>, rechtsnormgebunden: <xsl:value-of select="$AnzahlFeldgruppenRechtsnormgebunden"/></td>
				</tr>
				<tr>
					<td>&#160;&#160;Anzahl Datenfelder</td>
					<td><xsl:value-of select="$AnzahlFelder"/>, davon abstrakt: <xsl:value-of select="$AnzahlFelderAbstrakt"/>, harmonisiert: <xsl:value-of select="$AnzahlFelderHarmonisiert"/>, rechtsnormgebunden: <xsl:value-of select="$AnzahlFelderRechtsnormgebunden"/></td>
				</tr>
				<tr>
					<td>&#160;&#160;Anteil harmonisierter Baukastenelemente</td>
					<td><xsl:value-of select="format-number((fn:number($AnzahlFelderHarmonisiert) + fn:number($AnzahlFeldgruppenHarmonisiert)) div (fn:number($AnzahlFeldgruppen) + fn:number($AnzahlFelder)),'#.## %')"/></td>
				</tr>
				<tr>
					<td colspan="2">&#160;</td>
				</tr>
				<tr>
					<td>Anzahl Regeln</td>
					<td><xsl:value-of select="$AnzahlRegeln"/></td>
				</tr>
				<tr>
					<td colspan="2">&#160;</td>
				</tr>
				<tr>
					...
					<td><xsl:value-of select="$AnzahlCodelisten"/></td>
				</tr>
				<tr>
					<td colspan="2">&#160;</td>
				</tr>
		...
		<xsl:if test="$StatistikVerwendung = '1'">
			...
			<xsl:choose>
				<xsl:when test="$Statistik = '2'">
					<h3><a name="StatistikVerwendung"/>Verwendung von Baukastenelementen im FIM-Baustein Datenfelder&#160;<a href="#Statistik" title="nach oben">&#8593;</a><br/></h3>
				</xsl:when>
				<xsl:otherwise>
					<h3><a name="StatistikVerwendung"/>Verwendung von Baukastenelementen im FIM-Baustein Datenfelder<br/></h3>
				</xsl:otherwise>
			</xsl:choose>
				...
				<tbody>
					...
					<xsl:for-each-group select="//xdf:datenfeld | //xdf:datenfeldgruppe" group-by="concat(xdf:identifikation/xdf:id,xdf:identifikation/xdf:version)">
						...
						<xsl:if test="$DebugMode = '3' or $DebugMode = '4'">
							<xsl:message>
								-------- <xsl:value-of select="./xdf:identifikation/xdf:id"/><xsl:if test="./xdf:identifikation/xdf:version">V<xsl:value-of select="./xdf:identifikation/xdf:version"/></xsl:if> --------
							</xsl:message>
						</xsl:if>
		...
		<xsl:if test="$StatistikStrukturart = '1'">
			...
			<h3><a name="StatistikStrukturart"/>Baukastenelemente nach Strukturart<br/></h3>
					
			<xsl:choose>
				<xsl:when test="$Statistik = '2'">
					<h4><br/><a name="StatistikAbstrakte"/>Abstrakte Baukastenelemente&#160;<a href="#Statistik" title="nach oben">&#8593;</a><br/></h4>
				</xsl:when>
				<xsl:otherwise>
					<h4><br/><a name="StatistikAbstrakte"/>Abstrakte Baukastenelemente<br/></h4>
				</xsl:otherwise>
			</xsl:choose>
								...
								<td>
									<xsl:choose>
										<xsl:when test="$Statistik = '2' or empty(./xdf:identifikation/xdf:id)">
											<xsl:value-of select="./xdf:identifikation/xdf:id"/><xsl:if test="$ToolAufruf = '1'">&#160;&#160;<xsl:element name="a"><xsl:attribute name="href"><xsl:value-of select="$ToolPfadPrefix"/><xsl:value-of select="./xdf:identifikation/xdf:id"/><xsl:if test="./xdf:identifikation/xdf:version">V<xsl:value-of select="./xdf:identifikation/xdf:version"/></xsl:if><xsl:value-of select="$ToolPfadPostfix"/></xsl:attribute><xsl:attribute name="target">FIMTool</xsl:attribute><xsl:attribute name="title">Springe in den Datenfeldeditor (man muss vorher angemeldet sein).</xsl:attribute>&#8658;</xsl:element>&#160;&#160;&#160;&#160;</xsl:if>
										</xsl:when>
										<xsl:otherwise>
											<xsl:choose>
												<xsl:when test="$InterneLinks = '1'">
			...
			<xsl:choose>
				<xsl:when test="$Statistik = '2'">
					<h4><br/><a name="StatistikHarmonisierte"/>Harmonisierte Baukastenelemente&#160;<a href="#Statistik" title="nach oben">&#8593;</a><br/></h4>
				</xsl:when>
				<xsl:otherwise>
					<h4><br/><a name="StatistikHarmonisierte"/>Harmonisierte Baukastenelemente<br/></h4>
				</xsl:otherwise>
			</xsl:choose>
			...
			<xsl:choose>
				<xsl:when test="$Statistik = '2'">
					<h4><br/><a name="StatistikRechtsnormgebundene"/>Rechtsnormgebundene Baukastenelemente&#160;<a href="#Statistik" title="nach oben">&#8593;</a><br/></h4>
				</xsl:when>
				<xsl:otherwise>
					<h4><br/><a name="StatistikRechtsnormgebundene"/>Rechtsnormgebundene Baukastenelemente<br/></h4>
				</xsl:otherwise>
			</xsl:choose>
		...
		<xsl:if test="$StatistikZustandsinfos = '1'">
			...
			<xsl:choose>
				<xsl:when test="$Statistik = '2'">
					<h3><a name="StatistikZustandsinfos"/>Baukastenelemente ohne Ersteller oder nicht aktiv&#160;<a href="#Statistik" title="nach oben">&#8593;</a><br/></h3>
				</xsl:when>
				<xsl:otherwise>
					<h3><a name="StatistikZustandsinfos"/>Baukastenelemente ohne Ersteller oder nicht aktiv<br/></h3>
				</xsl:otherwise>
			</xsl:choose>
	...
	<xsl:template name="statistikzubaukasten">
		...
		<xsl:choose>
			<xsl:when test="$Statistik = '2'">
					<h2><a name="Statistik"/>Statistik zum Inhalt des FIM-Bausteins Datenfelder</h2>
					<xsl:if test="$StatistikVerwendung = '1'"><p><a href="#StatistikVerwendung">Verwendung der Elemente</a></p></xsl:if>
					<xsl:if test="$StatistikStrukturart = '1'"><p>Liste der Elemente: <a href="#StatistikAbstrakte">Abstrakte</a> - <a href="#StatistikHarmonisierte">Harmonisierte</a> - <a href="#StatistikRechtsnormgebundene">Rechtsnormgebundene</a></p></xsl:if>
					<xsl:if test="$StatistikZustandsinfos = '1'"><p><a href="#StatistikZustandsinfos">Baukastenelemente ohne Ersteller oder nicht aktiv</a></p></xsl:if>
					<xsl:if test="$StatistikFehlendeArbeitskopien = '1'"><p><a href="#StatistikFehlendeArbeitskopien">Baukastenelemente ohne Arbeitskopie</a></p></xsl:if>
			</xsl:when>
		...
		<table style="page-break-after:always">
			...
			<tbody>
				...
				<tr>
					...
					<td><xsl:value-of select="$AnzahlSteckbriefe"/>, Versionen mitgezählt: <xsl:value-of select="$AnzahlSteckbriefeMitVersionen"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><xsl:value-of select="$AnzahlSDS"/>, Versionen mitgezählt: <xsl:value-of select="$AnzahlSDSMitVersionen"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td>&#160;&#160;Anzahl Baukastenelemente</td>
					<td><xsl:value-of select="$AnzahlFeldgruppen + $AnzahlFelder"/>, Versionen mitgezählt: <xsl:value-of select="$AnzahlFeldgruppenMitVersionen + $AnzahlFelderMitVersion"/></td>
				</tr>
				<tr>
					<td>&#160;&#160;&#160;&#160;Anzahl Datenfeldgruppen</td>
					<td><xsl:value-of select="$AnzahlFeldgruppen"/>, davon abstrakt: <xsl:value-of select="$AnzahlFeldgruppenAbstrakt"/>, harmonisiert: <xsl:value-of select="$AnzahlFeldgruppenHarmonisiert"/>, rechtsnormgebunden: <xsl:value-of select="$AnzahlFeldgruppenRechtsnormgebunden"/></td>
				...
				<tr>
					<td>&#160;&#160;&#160;&#160;Anteil harmonisierter Baukastenelemente</td>
					<td><xsl:value-of select="format-number(($AnzahlFelderHarmonisiert + $AnzahlFeldgruppenHarmonisiert) div ($AnzahlFeldgruppen + $AnzahlFelder),'#.## %')"/></td>
				</tr>
				<tr>
					<td colspan="2">&#160;</td>
				</tr>
				<tr>
					<td>&#160;&#160;Anzahl Regeln</td>
					<td><xsl:value-of select="$AnzahlRegeln"/>, Versionen mitgezählt: <xsl:value-of select="$AnzahlRegelnMitVersion"/></td>
				</tr>
				<tr>
					<td colspan="2">&#160;</td>
				</tr>
			...
			<table style="page-break-after:always">
				...
				<tbody>
					...
					<xsl:for-each-group select="//xdf:enthaelt" group-by="xdf:id">
						...
						<xsl:variable name="ElementID"><xsl:choose><xsl:when test="substring-before(string(./xdf:id),'V')=''"><xsl:value-of select="string(./xdf:id)"/></xsl:when><xsl:otherwise><xsl:value-of select="substring-before(string(./xdf:id),'V')"/></xsl:otherwise></xsl:choose></xsl:variable>
						<xsl:variable name="ElementVersion"><xsl:value-of select="substring-after(string(./xdf:id),'V')"/></xsl:variable>
						...
						<xsl:if test="fn:position() = fn:last()">
							...
							<xsl:variable name="ListeUnverwendeterElemente">
								<xdf:ListeUnverwendeterElemente>
									<xsl:for-each-group select="//xdf:datenfeld | //xdf:datenfeldgruppe" group-by="concat(xdf:identifikation/xdf:id,xdf:identifikation/xdf:version)">
										...
										<xsl:variable name="ElementNameVersion"><xsl:value-of select="xdf:identifikation/xdf:id"/><xsl:if test="xdf:identifikation/xdf:version">V<xsl:value-of select="xdf:identifikation/xdf:version"/></xsl:if></xsl:variable>
										
										<xsl:variable name="ElementID" select="xdf:identifikation/xdf:id"/>
										<xsl:variable name="ElementVersion"><xsl:if test="xdf:identifikation/xdf:version"><xsl:value-of select="xdf:identifikation/xdf:version"/></xsl:if></xsl:variable>
										...
										<xsl:if test="not(//xdf:enthaelt[xdf:id = $ElementNameVersion])">
											...
											<xdf:eintrag>
												<xdf:id><xsl:value-of select='$ElementID'/></xdf:id>
												<xdf:version><xsl:value-of select='$ElementVersion'/></xdf:version>
											</xdf:eintrag>
							...
							<xsl:for-each select="$ListeUnverwendeterElemente/*/xdf:eintrag">
								...
								<xsl:variable name="ElementVersion"><xsl:if test="./xdf:version"><xsl:value-of select="./xdf:version"/></xsl:if></xsl:variable>
		...
		<xsl:if test="$StatistikFehlendeArbeitskopien = '1'">
			...
			<xsl:choose>
				<xsl:when test="$Statistik = '2'">
					<h3><a name="StatistikFehlendeArbeitskopien"/>Baukastenelemente ohne Arbeitskopie&#160;<a href="#Statistik" title="nach oben">&#8593;</a><br/></h3>
				</xsl:when>
				<xsl:otherwise>
					<h3><a name="StatistikFehlendeArbeitskopien"/>Baukastenelemente ohne Arbeitskopie<br/></h3>
				</xsl:otherwise>
			</xsl:choose>
		...
		<xsl:if test="$DebugMode = '1' or $DebugMode = '2' or $DebugMode = '3' or $DebugMode = '4'">
			<xsl:message>
				++++ stammdatenschemaeinzeln ++++
					...
					<h2>
						<a name="StammDetails"/>Details zum Datenschema <xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:id"/><xsl:if test="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version">&#160;Version&#160;<xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version"/></xsl:if>
					</h2>
					<table style="page-break-after:always">
						<thead>
							<tr>
				...
				-------- <xsl:value-of select="$Element/xdf:identifikation/xdf:id"/><xsl:if test="$Element/xdf:identifikation/xdf:version">V<xsl:value-of select="$Element/xdf:identifikation/xdf:version"/></xsl:if> --------
										...
										<tr>
											...
											<xsl:choose>
												...
												<td class="SDSName">
														<xsl:if test="$Meldungen = '1'"><div class="Fehler E1002">Fehler!! E1002: Der Name muss befüllt werden.</div></xsl:if>
													</td>
												</xsl:when>
												<xsl:otherwise>
										...
										<tr>
											...
											<xsl:choose>
												<xsl:when test="$Element/xdf:schemaelementart/code/text() = 'RNG' and empty($Element/xdf:bezug/text())">
													<td>
														<xsl:if test="$Meldungen = '1'"><div class="Fehler E1006">Fehler!! E1006: Der Bezug zur Handlungsgrundlage darf bei Elementen mit der Strukturelementart 'rechtsnormgebunden' nicht leer sein.</div></xsl:if>
													</td>
												</xsl:when>
												<xsl:when test="$Element/xdf:schemaelementart/code/text() = 'HAR' and empty($Element/xdf:bezug/text())">
													<td>
														<xsl:if test="$Meldungen = '1'"><div class="Warnung W1001">Warnung!! W1001: Der Bezug zur Handlungsgrundlage sollte bei Elementen mit der Strukturelementart 'harmonisiert' möglichst nicht leer sein.</div></xsl:if>
													</td>
												</xsl:when>
												<xsl:otherwise>
													<td>
											...
											<xsl:choose> 
												<xsl:when test="$Element/xdf:status/code/text() != 'aktiv' and $VersionsHinweise ='1'">
													<td>
														...
														<xsl:if test="$Meldungen = '1'"><div class="Hinweis">Hinweis!! Der Status muss zur Versionierung oder Veröffentlichung den Wert 'aktiv' haben.</div></xsl:if>
													</td>
												</xsl:when>
												<xsl:otherwise>
													<td>
											...
											<xsl:choose> 
												<xsl:when test="empty($Element/xdf:fachlicherErsteller/text()) and $VersionsHinweise ='1'">
													<td>
														...
														<xsl:if test="$Meldungen = '1'"><div class="Hinweis">Hinweis!! Der Fachliche Ersteller darf zur Versionierung oder Veröffentlichung nicht leer sein.</div></xsl:if>
													</td>
												</xsl:when>
												<xsl:otherwise>
													<td>
			...
			<h2>
				...
				<span id="elementlisteallealpha">
					<table style="page-break-after:always">
						<thead>
							<tr>
								<th>ID&#160;<a href="#" title="Sortiere nach ID" onclick="ZeigeAlleID(); return false;">&#8593;</a></th>
								<th>Version</th>
								<th>Name</th>
								<th>Bezeichnung</th>
							</tr>
					...
					<table style="page-break-after:always">
						<thead>
							<tr>
								<th>ID</th>
								<th>Version</th>
								<th>Name&#160;<a href="#" title="Sortiere nach Name" onclick="ZeigeAlleAlpha(); return false;">&#8593;</a></th>
								<th>Bezeichnung</th>
							</tr>
						</thead>
						<tbody>
		...
		<xsl:if test="$DebugMode = '1' or $DebugMode = '2' or $DebugMode = '3' or $DebugMode = '4'">
			<xsl:message>
				++++ listeelementedetailzustammdatenschema ++++
					...
					<h2><br/></h2>
					<h2>
						<a name="ElementDetails"/>Details zu den Baukastenelementen des Datenschemas <xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:id"/><xsl:if test="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version"> Version <xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version"/></xsl:if>
					</h2>
					<table style="page-break-after:always">
						<thead>
							<tr>
											...
											<tr>
												...
												<xsl:choose>
													<xsl:when test="empty($Element/xdf:bezug/text())">
														<td>
															<xsl:if test="$Meldungen = '1'"><div class="Fehler E1008">Fehler!! E1008: Der Bezug zur Handlungsgrundlage darf nicht leer sein.</div></xsl:if>
														</td>
													</xsl:when>
													<xsl:otherwise>
														<td>
											...
											<tr>
												...
												<xsl:choose>
													<xsl:when test="empty($Element/xdf:bezeichnungEingabe/text())">
														<td>
															<xsl:if test="$Meldungen = '1'"><div class="Fehler E1009">Fehler!! E1009: Die Bezeichnung Eingabe muss befüllt werden.</div></xsl:if>
														</td>
													</xsl:when>
													<xsl:otherwise>
														<td>
											...
											<tr>
												...
												<xsl:choose>
													<xsl:when test="empty($Element/xdf:hilfetext/text())">
														<td>
															<xsl:if test="$Meldungen = '1'"><div class="Warnung W1007">Warnung!! W1007: Der Hilfetext sollte befüllt werden.</div></xsl:if>
														</td>
													</xsl:when>
													<xsl:otherwise>
														<td>
												...
												<xsl:choose>
													<xsl:when test="$Element/xdf:schemaelementart/code/text() = 'ABS' and $AbstraktWarnung ='1'">
														<td>
															...
															<xsl:if test="$Meldungen = '1'"><div class="Fehler E1014">Fehler!! E1014: Datenfelder dürfen nicht die Strukturelementart 'abstrakt' haben.</div></xsl:if>
														</td>
													</xsl:when>
													<xsl:otherwise>
														<td>
													...
													<xsl:when test="$Element/xdf:feldart/code/text() = 'select'">
														<xsl:choose>
															...
															<xsl:when test="$Element/xdf:datentyp/code/text() = 'int'">
																<td>
																	<xsl:apply-templates select="$Element/xdf:datentyp"/>
																	<xsl:if test="$Meldungen = '1'"><div class="Warnung W1008">Warnung!! W1008: Bei Auswahlfeldern ist der Datentyp i. d. R. vom Typ 'Text'.</div></xsl:if>
																</td>
															</xsl:when>
															<xsl:otherwise>
																<td>
																	<xsl:apply-templates select="$Element/xdf:datentyp"/>
																	<xsl:if test="$Meldungen = '1'"><div class="Fehler E1011">Fehler!! E1011: Bei Datenfeldern mit der Feldart 'Auswahlfeld' sollte der Datentyp 'Text' sein - in seltenen Fällen 'Ganzzahl'.</div></xsl:if>
																</td>
															</xsl:otherwise>
														</xsl:choose>
													</xsl:when>
											...
											<tr>
												...
												<xsl:choose>
													<xsl:when test="$Element/xdf:praezisierung/text() != ''">
														...
														<xsl:variable name="minLength"><xsl:if test="substring-before(substring-after($Praezisierung,'minLength&quot;:&quot;'),'&quot;') != ''"><xsl:value-of select="substring-before(substring-after($Praezisierung,'minLength&quot;:&quot;'),'&quot;')"/></xsl:if></xsl:variable>
														<xsl:variable name="maxLength"><xsl:if test="substring-before(substring-after($Praezisierung,'maxLength&quot;:&quot;'),'&quot;') != ''"><xsl:value-of select="substring-before(substring-after($Praezisierung,'maxLength&quot;:&quot;'),'&quot;')"/></xsl:if></xsl:variable>
														...
														<xsl:choose>
																		...
																		<xsl:choose>
																			<xsl:when test="$minLength != '' or $maxLength != ''">
																				<td>
																					...
																					<xsl:if test="$Meldungen = '1'"><div class="Fehler E1012">Fehler!! E1012: Bei Datenfeldern mit der Feldart 'Auswahlfeld' oder 'Statisches, read-only Feld' sollten weder die minimale noch die maximale Feldlänge angegeben werden.</div></xsl:if>
																				</td>
																			</xsl:when>
																			<xsl:otherwise>
																				<td>
																		...
																		<xsl:choose>
																			...
																			<xsl:otherwise>
																				<td>
																					...
																					<xsl:if test="$Meldungen = '1'"><div class="Warnung W1002">Warnung!! W1002: Bei Eingabedatenfeldern mit dem Datentyp 'Text' sollten, wenn möglich, die minimale und maximale Feldlänge angegeben werden.</div></xsl:if>
																				</td>
																			</xsl:otherwise>
																		</xsl:choose>
															...
															<xsl:when test="$minLength != '' or $maxLength != ''">
																<td>
																	...
																	<xsl:if test="$Meldungen = '1'"><div class="Fehler E1015">Fehler!! E1015: Eine Feldlänge darf nur bei einem Datenfeld mit dem Datentyp 'Text' angegeben werden.</div></xsl:if>
																</td>
															</xsl:when>
															<xsl:otherwise>
																<td></td>
											...
											<tr>
												...
												<xsl:choose>
													<xsl:when test="$Element/xdf:praezisierung/text() != ''">
														...
														<xsl:variable name="minValue"><xsl:if test="substring-before(substring-after($Praezisierung,'minValue&quot;:&quot;'),'&quot;') != ''"><xsl:value-of select="substring-before(substring-after($Praezisierung,'minValue&quot;:&quot;'),'&quot;')"/></xsl:if></xsl:variable>
														<xsl:variable name="maxValue"><xsl:if test="substring-before(substring-after($Praezisierung,'maxValue&quot;:&quot;'),'&quot;') != ''"><xsl:value-of select="substring-before(substring-after($Praezisierung,'maxValue&quot;:&quot;'),'&quot;')"/></xsl:if></xsl:variable>
																...
																<xsl:choose>
																	<xsl:when test="$minValue != '' or $maxValue != ''">
																		<td>
																			...
																			<xsl:if test="$Meldungen = '1'"><div class="Fehler E1016">Fehler!! E1016: Ein Wertebereich darf nur bei einem Datenfeld mit einem nummerischen Datentyp (Nummer, Ganzzahl, Geldbetrag) angegeben werden.</div></xsl:if>
																		</td>
																	</xsl:when>
																	<xsl:otherwise>
																		<td>
													...
													<xsl:otherwise>
														<xsl:choose>
															<xsl:when test="$Element/xdf:datentyp/code/text() = 'num' or $Element/xdf:datentyp/code/text() = 'num_int' or $Element/xdf:datentyp/code/text() = 'num_currency'">
																<td>
																	<xsl:if test="$Meldungen = '1'"><div class="Warnung W1003">Warnung!! W1003: Bei Datenfeldern mit dem Datentyp 'Nummer', 'Ganzzahl' oder 'Geldbetrag' sollte, wenn möglich, ein Wertebereich angegeben werden.</div></xsl:if>
																</td>
															</xsl:when>
															<xsl:otherwise>
																<td></td>
												...
												<xsl:choose>
													<xsl:when test="$Element/xdf:feldart/code/text() != 'select' and $Element/xdf:codeliste">
														<td>
															...
															<xsl:if test="$Meldungen = '1'"><div class="Fehler E1017">Fehler!! E1017: Ist eine Codeliste zugeordnet, muss die Feldart 'Auswahlfeld' sein.</div></xsl:if>
														</td>
													</xsl:when>
													<xsl:when test="$Element/xdf:feldart/code/text() = 'select' and not($Element/xdf:codeliste)">
														<td>
															<xsl:if test="$Meldungen = '1'"><div class="Fehler E1018">Fehler!! E1018: Wenn ein Datenfeld die Feldart 'Auswahlfeld' hat, muss eine Codeliste zugeordnet sein.</div></xsl:if>
														</td>
													</xsl:when>
													...
													<xsl:choose>
														...
														<xsl:otherwise>
															<td>
																...
																<xsl:if test="$Meldungen = '1'"><div class="Fehler E1035">Fehler!! E1035: Hinweis noch im alten Format. Element muss nochmals gespeichert werden.</div></xsl:if>
															</td>
														</xsl:otherwise>
													</xsl:choose>
											...
											<tr>
												...
												<xsl:choose>
													<xsl:when test="$Element/xdf:feldart/code/text() = 'label' and empty($Element/xdf:inhalt/text())">
														<td>
															<xsl:if test="$Meldungen = '1'"><div class="Warnung W1009">Warnung!! W1009: Bei einem Feld mit nur lesendem Zugriff, der Feldart 'Statisch' wird i. d. R. der Inhalt mit einem Text befüllt.</div></xsl:if>
														</td>
													</xsl:when>
													<xsl:otherwise>
														<td>
											...
											<tr>
												...
												<xsl:choose>
													<xsl:when test="empty($Element/xdf:bezeichnungAusgabe/text())">
														<td>
															<xsl:if test="$Meldungen = '1'"><div class="Fehler E1010">Fehler!! E1010: Die Bezeichnung Ausgabe muss befüllt werden.</div></xsl:if>
														</td>
													</xsl:when>
													<xsl:otherwise>
														<td>
																		...
																		<td>
																			...
																			<xsl:if test="$Meldungen = '1'">
																				...
																				<xsl:for-each-group select="$regellistedoppelte/*/xdf:elementid" group-by=".">
																					<xsl:sort/>
																					<xsl:variable name="TestElement"><xsl:value-of select="."/></xsl:variable>
...
-->
											<tr>
												...
												<xsl:choose>
													...
													<xsl:otherwise>
														<td>
															<xsl:if test="$Meldungen = '1'"><div class="Warnung W1014">Warnung!! W1014: Element wird nicht verwendet.</div></xsl:if>
														</td>
													</xsl:otherwise>
												</xsl:choose>
											</tr>
...
-->
												<tr>
													...
													<xsl:choose>
																...
																<table>
																	...
																	<tbody>
																		...
																		<xsl:for-each select="$Element/xdf:struktur">
																			...
																			<xsl:variable name="ElementID"><xsl:choose><xsl:when test="substring-before(string(./xdf:enthaelt/xdf:id),'V')=''"><xsl:value-of select="string(./xdf:enthaelt/xdf:id)"/></xsl:when><xsl:otherwise><xsl:value-of select="substring-before(string(./xdf:enthaelt/xdf:id),'V')"/></xsl:otherwise></xsl:choose></xsl:variable>
																			<xsl:variable name="ElementVersion"><xsl:value-of select="substring-after(string(./xdf:enthaelt/xdf:id),'V')"/></xsl:variable>
																			<xsl:variable name="VergleichsElementIDVersion"><xsl:value-of select="./xdf:enthaelt/xdf:id"/></xsl:variable>
																				...
																				<tr>
																					<td>
																						...
																						<xsl:if test="count($Element/xdf:struktur/xdf:enthaelt[xdf:id=$VergleichsElementIDVersion]) &gt; 1">
																							<xsl:if test="$Meldungen = '1'"><div class="Fehler E1004">Fehler!! E1004: In einer Datenfeldgruppe darf kein Baukastenelement mehrfach in derselben Version enthalten sein.</div></xsl:if>
																						</xsl:if>
																					</td>
																					<td>
																						<xsl:value-of select="$ElementVersion"/>
																					...
																					<xsl:choose>
																						<xsl:when test="$Unterlement/*/xdf:schemaelementart/code/text() = 'ABS' and $AbstraktWarnung = '1'">
																							<td>
																								...
																								<xsl:if test="$Meldungen = '1'"><div class="Fehler E1013">Fehler!! E1013: Innerhalb von Datenschemata und Datenfeldgruppen dürfen nur Elemente mit der Strukturelementart harmonisiert oder rechtnormgebunden verwendet werden.</div></xsl:if>
																							</td>
																						</xsl:when>
																						<xsl:otherwise>
																							<td>
																					...
																					<xsl:choose>
																						<xsl:when test="$Unterlement/*/xdf:status/code/text() = 'inaktiv'">
																							<td>
																								...
																								<xsl:if test="$Meldungen = '1'"><div class="Warnung W1016">Warnung!! W1016: Baukastenelemente im Status 'inaktiv' sollten nur in Ausnahmefällen verwendet werden.</div></xsl:if>
																							</td>
																						</xsl:when>
																					...
																					<xsl:choose>
																						<xsl:when test="./xdf:anzahl='0:0'">
																							<td>
																								...
																								<xsl:if test="$Meldungen = '1'"><div class="Fehler E1021">Fehler!! E1021: Es ist keine Multiplizität angegeben.</div></xsl:if>
																							</td>
																						</xsl:when>
																						<xsl:otherwise>
																							<td>
																					...
																					<xsl:choose>
																						<xsl:when test="$Strukturelementart ='RNG' and ($Unterlement/*/xdf:schemaelementart/code/text() = 'ABS' or $Unterlement/*/xdf:schemaelementart/code/text() = 'HAR') and empty(./xdf:bezug/text())">
																							<td>
																								<xsl:if test="$Meldungen = '1'"><div class="Fehler E1022">Fehler!! E1022: Bei Verwendung von Elementen mit der Strukturelementart 'harmonisiert' innerhalb von Datenfeldgruppen mit der Strukturelementart 'rechtsnormgebunden' muss zur Multiplizität ein Bezug zu einer Handlungsgrundlage angegeben werden.</div></xsl:if>
																							</td>
																						</xsl:when>
																						<xsl:otherwise>
																							<td>
														...
														<xsl:otherwise>
															<td>
																<xsl:if test="$Meldungen = '1'"><div class="Fehler E1023">Fehler!! E1023: Datenfeldgruppe hat keine Unterelemente.</div></xsl:if>
															</td>
														</xsl:otherwise>
													</xsl:choose>
												</tr>
...
-->
											<tr>
												...
												<xsl:variable name="FeldIgruppenDmitVersion"><xsl:value-of select="$Element/xdf:identifikation/xdf:id"/><xsl:if test="$Element/xdf:identifikation/xdf:version">V<xsl:value-of select="$Element/xdf:identifikation/xdf:version"/></xsl:if></xsl:variable> 
											...
											<tr>
												...
												<xsl:choose>
													<xsl:when test="empty($Element/xdf:identifikation/xdf:id/text())">
														<td class="ElementID">
															<xsl:if test="$Meldungen = '1'"><div class="Fehler E1038">Fehler!! E1038: Die ID muss befüllt werden.</div></xsl:if>
														</td>
													</xsl:when>
													<xsl:otherwise>
														<td class="ElementID">
															...
															<xsl:analyze-string regex="F\d{{8}}" select="$Element/xdf:identifikation/xdf:id">
																...
																<xsl:non-matching-substring>
																	<xsl:if test="$Meldungen = '1'"><div class="Fehler E1039">Fehler!! E1039: Die ID entspricht nicht den Formatvorgaben.</div></xsl:if>
																</xsl:non-matching-substring>
															</xsl:analyze-string>
														</td>
													</xsl:otherwise>
											...
											<tr>
												...
												<xsl:choose>
													<xsl:when test="$VersionsAnzahl &gt; 1">
														<td>
															<xsl:value-of select="$Element/xdf:identifikation/xdf:version"/>
															<xsl:if test="$Meldungen = '1'"><div class="Fehler E1003">Fehler!! E1003: Im selben Datenschema darf ein Baukastenelement nicht in unterschiedlichen Versionen verwendet werden.</div></xsl:if>
														</td>
													</xsl:when>
													<xsl:otherwise>
														<td>
																...
																<table>
																	...
																	<tbody>
																		...
																		<xsl:for-each select="$Element/xdf:struktur">
																			...
																			<xsl:variable name="VergleichsElement"><xsl:value-of select="./xdf:enthaelt/*/xdf:identifikation/xdf:id"/></xsl:variable>
																					...
																					<xsl:choose> 
																						<xsl:when test="empty(./xdf:enthaelt/*/xdf:identifikation/xdf:version/text()) and $VersionsHinweise ='1'">
																							<td>
																								...
																								<xsl:if test="$Meldungen = '1'"><div class="Hinweis">Hinweis!! Zur Versionierung und Veröffentlichung müssen alle verwendete Unterelemente versioniert sein.</div></xsl:if>
																							</td>
																						</xsl:when>
																						<xsl:otherwise>
																							<td>
		...
		<xsl:if test="$DebugMode = '1' or $DebugMode = '2' or $DebugMode = '3' or $DebugMode = '4'">
			<xsl:message>
				++++ listeregeldetailszustammdatenschema ++++
					...
					<h2><br/></h2>
					<h2>
						<a name="RegelDetails"/>Details zu den Regeln des Datenschemas <xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:id"/><xsl:if test="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version"> Version <xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version"/></xsl:if>
					</h2>
					<table style="page-break-after:always">
						<thead>
							<tr>
				...
				-------- <xsl:value-of select="$Element/xdf:identifikation/xdf:id"/><xsl:if test="$Element/xdf:identifikation/xdf:version">V<xsl:value-of select="$Element/xdf:identifikation/xdf:version"/></xsl:if> --------
								...
								<tr>
									...
									<xsl:choose>
										...
										<td>
												<xsl:if test="$Meldungen = '1'"><div class="Fehler E1024">Fehler!! E1024: Die Definition muss befüllt sein.</div></xsl:if>
											</td>
										</xsl:when>
										<xsl:otherwise>
											<td>
									...
									<xsl:variable name="ListeDoppelteCodelisten">
										<xdf:ListeDoppelteCodelisten>
											<xsl:for-each-group select="//xdf:codeliste[xdf:identifikation/xdf:id != $CodelisteFIMID and xdf:genericodeIdentification/xdf:canonicalVersionUri = $CodelisteGenericodeIDVersion]" group-by="xdf:identifikation/xdf:id">
												<xsl:sort select="xdf:identifikation/xdf:id"/>
												<xdf:codeliste><xsl:value-of select="xdf:identifikation/xdf:id"/></xdf:codeliste>
											</xsl:for-each-group>
										</xdf:ListeDoppelteCodelisten>
									</xsl:variable>
		...
		<xsl:if test="$DebugMode = '1' or $DebugMode = '2' or $DebugMode = '3' or $DebugMode = '4'">
			<xsl:message>
				++++ listecodelistendetailszustammdatenschema ++++
					...
					<h2><br/></h2>
					<h2>
						<a name="CodelisteDetails"/>Details zu den Codelisten des Datenschemas <xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:id"/><xsl:if test="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version"> Version <xsl:value-of select="/*/xdf:stammdatenschema/xdf:identifikation/xdf:version"/></xsl:if>
					</h2>
					<table style="page-break-after:always">
						<thead>
							<tr>
									...
									<xsl:variable name="ListeDoppelteCodelisten">
										<xdf:ListeDoppelteCodelisten>
											<xsl:for-each-group select="//xdf:datenfeld[xdf:codelisteReferenz/xdf:identifikation/xdf:id != $CodelisteFIMID and xdf:codelisteReferenz/xdf:genericodeIdentification/xdf:canonicalVersionUri = $CodelisteGenericodeIDVersion]" group-by="xdf:codelisteReferenz/xdf:identifikation/xdf:id">
												...
												<xdf:codeliste><xsl:value-of select="xdf:codelisteReferenz/xdf:identifikation/xdf:id"/></xdf:codeliste>
											</xsl:for-each-group>
										</xdf:ListeDoppelteCodelisten>
									</xsl:variable>
				...
				-------- <xsl:value-of select="$Element/xdf:identifikation/xdf:id"/> --------
								...
								<tr>
									...
									<td>
										...
										<xsl:if test="count($ListeDoppelteCodelisten/*/xdf:codeliste) &gt; 0">
											<xsl:if test="$Meldungen = '1'"><div class="Fehler E1036">Fehler!! E1036: Die Kombination aus Kennung und Version muss immer eindeutig sein. Dies steht im Konflikt mit Codeliste(n) 
								...
								<tr>
									...
									<xsl:choose>
										<xsl:when test="empty($Element/xdf:name/text())">
										<td class="ElementName">
												<xsl:if test="$Meldungen = '1'"><div class="Fehler 1002">Fehler!! E1002: Der Name muss befüllt werden.</div></xsl:if>
											</td>
										</xsl:when>
										<xsl:otherwise>
											<td class="ElementName">
								...
								<tr>
									...
									<xsl:choose>
										<xsl:when test="empty($Element/xdf:genericodeIdentification/xdf:canonicalIdentification/text())">
											<td>
												<xsl:if test="$Meldungen = '1'"><div class="Fehler E1040">Fehler!! E1040: Die Kennung ist leer.</div></xsl:if>
											</td>
										</xsl:when>
										<xsl:when test="substring($Element/xdf:genericodeIdentification/xdf:canonicalIdentification/text(),1,4) != 'urn:'">
											<td>
												...
												<xsl:if test="$Meldungen = '1'"><div class="Fehler E1005">Fehler!! E1005: Die Kennung ist nicht als URN formuliert, z.B. urn:de:fim:codeliste:dokumenttyp.</div></xsl:if>
											</td>
										</xsl:when>
										<xsl:otherwise>
											<td>
									...
									<xsl:choose>
										<xsl:when test="substring($Element/xdf:genericodeIdentification/xdf:version/text(),5,1) != '-' or substring($Element/xdf:genericodeIdentification/xdf:version/text(),8,1) != '-'">
											<td>
												...
												<xsl:if test="$Meldungen = '1'"><div class="Warnung W1005">Warnung!! W1005: Die Version sollte im Datumsformat in folgender Form angegeben werden, z.B. 2018-03-01.</div></xsl:if>
											</td>
										</xsl:when>
										<xsl:otherwise>
											<td>
								...
								<tr>
									...
									<xsl:choose>
										<xsl:when test="empty($Element/xdf:bezug/text())">
											<td>
												<xsl:if test="$Meldungen = '1'"><div class="Warnung W1010">Warnung!! W1010: Der Bezug zur Handlungsgrundlage sollte nicht leer sein.</div></xsl:if>
											</td>
										</xsl:when>
										<xsl:otherwise>
											<td>
														...
														<thead>
															<tr>
																<xsl:for-each select="$CodelisteInhalt/*/gc:ColumnSet/gc:Column">
																	<th><xsl:value-of select="./gc:ShortName"/></th>
																</xsl:for-each>
																<xsl:for-each select="$CodelisteInhalt/*/ColumnSet/Column">
																	<th><xsl:value-of select="./ShortName"/></th>
																</xsl:for-each>
															</tr>
														</thead>
														<tbody>
...
-->
								<tr>
									...
									<xsl:choose>
										...
										<xsl:otherwise>
											<td>
												<xsl:if test="$Meldungen = '1'"><div class="Warnung W1011">Warnung!! W1011: Codeliste wird nicht verwendet.</div></xsl:if>
											</td>
										</xsl:otherwise>
									</xsl:choose>
								</tr>
			...
			<xsl:message>
				-------- <xsl:value-of select="$Element/xdf:identifikation/xdf:id"/> --------
								...
								<tr>
									...
									<td>
										<xsl:value-of select="$Element/xdf:identifikation/xdf:id"/>
<!--										<xsl:analyze-string regex="C\d{{8}}" select="$Element/xdf:identifikation/xdf:id"> -->
										<xsl:analyze-string regex="C\d{{8}}(V\d{{1,3}}\.\d{{1,3}}\.\d{{1,3}})?" select="$Element/xdf:identifikation/xdf:id">
											<xsl:matching-substring>
												<xsl:if test="$ToolAufruf = '1'">
													&#160;&#160;
													<xsl:element name="a">
								...
								<tr>
									...
									<xsl:choose>
										<xsl:when test="count($ListeMehrereCodelistenVersionen/*/xdf:codeliste) &gt; 0">
											<td>
												<xsl:value-of select="$Element/xdf:genericodeIdentification/xdf:version"/>
												<xsl:if test="$Meldungen = '1'"><div class="Fehler E1037">Fehler!! E1037: In einem Datenschema darf eine Codeliste nicht in mehreren Versionen verwendet werden. Dies steht im Konflikt mit Codeliste(n) 
...
-->
	...
	<xsl:template name="unterelementezubaukasten">
		...
		<xsl:if test="$DebugMode = '4'">
			...
			<xsl:variable name="OriginalID"><xsl:value-of select="$Element/xdf:identifikation/xdf:id"/><xsl:if test="$Element/xdf:identifikation/xdf:version">V<xsl:value-of select="$Element/xdf:identifikation/xdf:version"/></xsl:if></xsl:variable>
														<xsl:for-each select="$Element/xdf:regel">
															<tr class="Regel">
																<td>
														...
														<xsl:for-each select="$Element/xdf:struktur">
																...
																<tr>
																	<td>
																		...
																		<xsl:if test="$Tiefe = 1 and count($Element/xdf:struktur/xdf:enthaelt[xdf:id=$VergleichsElementIDVersion]) &gt; 1">
																			<xsl:if test="$Meldungen = '1'"><div class="Fehler E1025">Fehler!! E1025: In einem Datenschema darf auf oberster Ebene kein Baukastenelement mehrfach in derselben Version enthalten sein.</div></xsl:if>
																		</xsl:if>
																	</td>
																	<td>
																		<xsl:value-of select="$ElementVersion"/>
																	...
																	<xsl:choose>
																		<xsl:when test="$Unterlement/*/xdf:schemaelementart/code/text() = 'ABS'and $Tiefe = 1 and $AbstraktWarnung ='1'">
																			<td>
																				<xsl:apply-templates select="$Unterlement/*/xdf:schemaelementart"/>																				<xsl:if test="$Meldungen = '1'"><div class="Fehler E1013">Fehler!! E1013: Innerhalb von Datenschemata und Datenfeldgruppen dürfen nur Elemente mit der Strukturelementart harmonisiert oder rechtnormgebunden verwendet werden.</div></xsl:if>
																			</td>
																		</xsl:when>
																		<xsl:otherwise>
																			<td>
																				<xsl:apply-templates select="$Unterlement/*/xdf:schemaelementart"/>																			</td>
																		</xsl:otherwise>
																	</xsl:choose>
																	<xsl:choose>
																	...
																	<xsl:choose>
																		<xsl:when test="./xdf:anzahl='0:0'and $Tiefe = 1">
																			<td>
																				<xsl:value-of select="./xdf:anzahl"/>
																				<xsl:if test="$Meldungen = '1'"><div class="Fehler E1021">Fehler!! E1021: Es ist keine Multiplizität angegeben.</div></xsl:if>
																			</td>
																	...
																	<xsl:choose>
																		<xsl:when test="$Strukturelementart ='RNG' and ($Unterlement/*/xdf:schemaelementart/code/text() = 'ABS' or $Unterlement/*/xdf:schemaelementart/code/text() = 'HAR') and empty(./xdf:bezug/text())and $Tiefe = 1">
																			<td>
																				<xsl:if test="$Meldungen = '1'"><div class="Fehler E1022">Fehler!! E1022: Bei Verwendung von Elementen mit der Strukturelementart 'abstrakt' oder 'harmonisiert' innerhalb von Datenfeldgruppen mit der Strukturelementart 'rechtsnormgebunden' muss zur Multiplizität ein Bezug zu einer Handlungsgrundlage angegeben werden.</div></xsl:if>
																			</td>
																		</xsl:when>
																		<xsl:when test="$Strukturelementart ='SDS' and ($Unterlement/*/xdf:schemaelementart/code/text() = 'ABS' or $Unterlement/*/xdf:schemaelementart/code/text() = 'HAR') and empty(./xdf:bezug/text())and $Tiefe = 1">
																			<td>
																				<xsl:if test="$Meldungen = '1'"><div class="Fehler E1022">Fehler!! E1022: Bei Verwendung von Elementen mit der Strukturelementart 'abstrakt' oder 'harmonisiert' auf oberster Ebene eines Datenschemas muss zur Multiplizität ein Bezug zu einer Handlungsgrundlage angegeben werden.</div></xsl:if>
																			</td>
																		</xsl:when>
																		<xsl:otherwise>
																			<td>
																...
																<xsl:choose>
																	<xsl:when test="fn:compare(string(./xdf:enthaelt/xdf:id),string($OriginalID)) = 0">
																		<tr>
																			<td colspan="8">
																				<xsl:if test="$Meldungen = '1'"><div class="Fehler E1026">Fehler!! E1026: Zirkelbezug</div></xsl:if>
																			</td>
																		</tr>
																	</xsl:when>
																	<xsl:otherwise>
																	...
																	<td colspan="4">
																		...
																		<xsl:if test="$Tiefe = 1">
																			...
																			<xsl:for-each-group select="$regellistedoppelte/*/xdf:elementid" group-by=".">
																				...
																				<xsl:variable name="TestElement"><xsl:value-of select="."/></xsl:variable>
																				<xsl:if test="fn:not($Element//xdf:identifikation[xdf:id/text() = $TestElement])">
																					<xsl:if test="$Meldungen = '1'"><div class="Fehler E1001">Fehler!! E1001: Die Regel kann auf kein Baukastenelement mit der ID <xsl:value-of select="$TestElement"/> zugreifen.</div></xsl:if>
																				</xsl:if>
																			</xsl:for-each-group>
																			<xsl:variable name="regellisteversionen">
																				<xdf:enthaltenebaukastenelemente>
																...
																<tr>
																	...
																	<xsl:choose>
																		<xsl:when test="./xdf:enthaelt/*/xdf:schemaelementart/code/text() = 'ABS' and $Tiefe = 1 and$AbstraktWarnung ='1'">
																			<td>
																				<xsl:apply-templates select="./xdf:enthaelt/*/xdf:schemaelementart"/>																				<xsl:if test="$Meldungen = '1'"><div class="Fehler E1013">Fehler!! E1013: Innerhalb von Datenschemata und Datenfeldgruppen dürfen nur Elemente mit der Strukturelementart harmonisiert oder rechtnormgebunden verwendet werden.</div></xsl:if>
																			</td>
																		</xsl:when>
																		<xsl:otherwise>
																			<td>
																				<xsl:apply-templates select="./xdf:enthaelt/*/xdf:schemaelementart"/>																			</td>
																		</xsl:otherwise>
																	</xsl:choose>
																	<xsl:choose>
	...
	<xsl:template match="xdf:feldart">
		<xsl:choose>
			...
			<xsl:otherwise><xsl:if test="$Meldungen = '1'"><div class="Fehler E1027">Fehler!! E1027: Unbekannte Feldart</div></xsl:if></xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template match="xdf:datentyp">
		<xsl:choose>
			...
			<xsl:otherwise><xsl:if test="$Meldungen = '1'"><div class="Fehler E1028">Fehler!! E1028: Unbekannter Datentyp</div></xsl:if></xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template match="xdf:schemaelementart">
		<xsl:choose>
			...
			<xsl:otherwise><xsl:if test="$Meldungen = '1'"><div class="Fehler E1031">Fehler!! E1031: Unbekannte Strukturelementart</div></xsl:if></xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template match="xdf:status">
		<xsl:choose>
			...
			<xsl:otherwise><xsl:if test="$Meldungen = '1'"><div class="Fehler E1032">Fehler!! E1032: Unbekannter Status</div></xsl:if></xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template match="xdf:ableitungsmodifikationenStruktur">
		<xsl:choose>
			...
			<xsl:otherwise><xsl:if test="$Meldungen = '1'"><div class="Fehler E1033">Fehler!! E1033: Unbekannte Änderbarkeit der Struktur</div></xsl:if></xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template match="xdf:ableitungsmodifikationenRepraesentation">
		<xsl:choose>
			...
			<xsl:otherwise><xsl:if test="$Meldungen = '1'"><div class="Fehler E1034">Fehler!! E1034: Unbekannte Änderbarkeit der Repräsentation</div></xsl:if></xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	...
	-->
		...
		<xsl:choose>
			<xsl:when test="$Navigation = '1' and $Statistik != '2'">
				<br/><span class="TrennerNavi"><a style="text-decoration:none;" href="#" title="Öffne das Navigationsfenster" onclick="ZeigeNavigation(); return false;">.</a></span><hr/><br/>
			</xsl:when>
			<xsl:otherwise>
				<br/><hr/><br/>
			</xsl:otherwise>
	...
	<xsl:if test="$JavaScript = '1'">
		...
		<script type="text/javascript">
			...
			<xsl:if test="$MeldungsFazit = '1' and $Meldungen = '1' and $JavaScript = '1'">
				...
				{
					document.getElementById("FehlerListe").insertAdjacentHTML('beforeend', document.querySelectorAll('.E1002').length + " mal E1002: Der Name eines Objektes ist nicht gesetzt." + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>");
				}
				if (document.querySelectorAll('.E1003').length != 0)
				{
					document.getElementById("FehlerListe").insertAdjacentHTML('beforeend', document.querySelectorAll('.E1003').length + " mal E1003: Im selben Datenschema darf ein Baukastenelement nicht in unterschiedlichen Versionen verwendet werden." + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>");
				}
				if (document.querySelectorAll('.E1004').length != 0)
				{
					document.getElementById("FehlerListe").insertAdjacentHTML('beforeend', document.querySelectorAll('.E1004').length + " mal E1004: In einer Datenfeldgruppe darf kein Baukastenelement mehrfach in derselben Version enthalten sein." + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>");
				}
...
-->				if (document.querySelectorAll('.E1021').length != 0)
				...
				{
					document.getElementById("FehlerListe").insertAdjacentHTML('beforeend', document.querySelectorAll('.E1024').length + " mal E1024: Die Definition muss befüllt sein." + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>");
				}
				if (document.querySelectorAll('.E1025').length != 0)
				{
					document.getElementById("FehlerListe").insertAdjacentHTML('beforeend', document.querySelectorAll('.E1025').length + " mal E1025: In einem Datenschema darf auf oberster Ebene kein Baukastenelement mehrfach in derselben Version enthalten sein." + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>");
				}
...
-->
				...
				{
					document.getElementById("WarnungsListe").insertAdjacentHTML('beforeend', document.querySelectorAll('.W1008').length + " mal W1008: Bei Auswahlfeldern ist der Datentyp i. d. R. vom Typ 'Text'." + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>");
				}
	...
	<xsl:template name="formularsteckbriefliste">
					<h2>
						<a name="FormularListe"/>Übersicht der Formularsteckbriefe</h2>
					<table style="page-break-after:always">
						<thead>
							<tr>
								<th>ID</th>
						...
						<tbody>
							<xsl:for-each select="$Daten/*/Formularsteckbriefe/Formularsteckbrief">
	...
	<xsl:template name="stammformularliste">
					<h2>
						<a name="StammListe"/>Übersicht der Stammformulare</h2>
					<table style="page-break-after:always">
						<thead>
							<tr>
								<th>ID</th>
						...
						<tbody>
							<xsl:for-each select="$Daten/*/Stammformulare/Stammformular">
								<xsl:sort select="Id"/>
								<xsl:variable name="ElementID" select="./xdf:id"/>
								<xsl:variable name="Element">
									<xsl:copy-of select="$Daten/*/Formularsteckbriefe/Formularsteckbrief[Id = $ElementID]"/>
								...
								<tr>
									<td>
										<xsl:element name="a">
											<xsl:attribute name="href">#SF<xsl:value-of select="./xdf:id"/></xsl:attribute>
											<xsl:value-of select="./xdf:id"/>
										</xsl:element>
									</td>
									<td>
		...
		<xsl:param name="StammformularVersion"/>
				...
				<span id="elementlisteauszugalpha">
					...
					<table style="page-break-after:always">
						<thead>
							<tr>
								<th>ID&#160;<a href="#" onclick="ZeigeAuszugID(); return false;">&#8593;</a></th>
								<th>Version</th>
								<th>Name</th>
								<th>Bezeichnung</th>
							</tr>
						...
						<tbody>
							<xsl:for-each-group select="//$UnterelementIDsGesamtUnsortiert/*/xdf:id" group-by=".">
								<xsl:sort select=".././xdf:name"/>
								<xsl:variable name="ElementID"><xsl:value-of select="."/></xsl:variable>
					...
					<table style="page-break-after:always">
						<thead>
							<tr>
								<th>ID</th>
								<th>Version</th>
								<th>Name&#160;<a href="#" onclick="ZeigeAuszugAlpha(); return false;">&#8593;</a></th>
								<th>Bezeichnung</th>
							</tr>
						</thead>
						<tbody>
			...
			<xsl:param name="Element"/>
															<xsl:for-each select="//$Element/xdf:regeln/xdf:regel">
																...
																<xsl:element name="KopfDaten">
																			...
																			<xsl:element name="Name"><xsl:value-of select="$Element2/*/Bezeichnung"/></xsl:element>
																</xsl:element>
															</xsl:for-each>
														<xsl:for-each select="//$Element/xdf:struktur/*">
																<xsl:variable name="ElementID" select="./xdf:id"/>
	...
	<xsl:template name="elementdetailslisteauszug">
		<xsl:param name="StammformularID"/>
		<xsl:param name="StammformularVersion"/>
				...
				<xsl:variable name="UnterelementIDsGesamtUnsortiert">
					...
					<h2>
						<a name="ElementDetails"/>Details zu den Baukastenelementen im Stammformular <xsl:value-of select="$StammformularID"/>&#160;Version&#160;<xsl:value-of select="$StammformularVersion"/>
					</h2>
					<table style="page-break-after:always">
						<thead>
							<tr>
						...
						<tbody>
							<xsl:for-each-group select="//$UnterelementIDsGesamtUnsortiert/*/xdf:id" group-by=".">
								...
								<xsl:variable name="ElementID"><xsl:value-of select="."/></xsl:variable>
									...
									<xsl:call-template name="elementdetailszustammdatenschema">
										<xsl:with-param name="Element" select="$ElementID"/>
									</xsl:call-template>
