...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:html="http://www.w3.org/1999/xhtml" xmlns="http://www.w3.org/1999/xhtml" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xdf="urn:xoev-de:fim:standard:xdatenfelder_2" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" exclude-result-prefixes="html">
	...
	<xsl:variable name="StyleSheetName" select="'QS-DF_0_966_xdf2.xsl'"/> <!-- BackUp, falls fn:static-base-uri() leer -->
									...
									<xsl:choose>
										<xsl:when test="$minValue != '' or $maxValue != ''">
											<td>
												...
												<xsl:if test="$Meldungen = '1'">
													<div class="Fehler E1016">Fehler!! E1016: Ein Wertebereich darf nur bei einem Datenfeld mit einem nummerischen Datentyp (Fließkommazahl, Ganzzahl, Währungswert) angegeben werden.</div>
												</xsl:if>
											</td>
										</xsl:when>
										<xsl:otherwise>
