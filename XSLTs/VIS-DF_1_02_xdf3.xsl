...
<xsl:stylesheet 
	...
	exclude-result-prefixes="html fn xdf3 gc ext bdt dat svrl">
	
	<xsl:variable name="StyleSheetURI" select="fn:static-base-uri()"/>
	<xsl:variable name="DocumentURI" select="fn:document-uri(.)"/>

	<xsl:variable name="StyleSheetName" select="'VIS-DF_1_02_xdf3.xsl'"/> <!-- BackUp, falls fn:static-base-uri() leer -->
					...
					<xsl:choose>
						<xsl:when test="name(/*) ='xdf3:xdatenfelder.stammdatenschema.0102'">
							...
							<p class="SehrKlein">
								...
								Infobox: <xsl:value-of select="$Infobox"/><br/>
								Copybutton: <xsl:value-of select="$Copybutton"/><br/>
								ZeigeVersteckte: <xsl:value-of select="$ZeigeVersteckte"/><br/>
								ToolAufruf: <xsl:value-of select="$ToolAufruf"/>
							</p>
			...
			<div class="SDSBezeichnung">
				...
				<xsl:if test="$Infobox = '1'">
					...
					<xsl:variable name="Infoboxinhalt">
						...
						<b>Name:&#160;&#160;</b><xsl:value-of select="//xdf3:xdatenfelder.datenfeldgruppe.0103/xdf3:datenfeldgruppe/xdf3:name"/><br/><br/>
						<b>Bezeichnung Ausgabe:</b>&#160;&#160;<xsl:value-of select="//xdf3:xdatenfelder.datenfeldgruppe.0103/xdf3:datenfeldgruppe/xdf3:bezeichnungAusgabe"/><br/>
						<b>Hilfetext Ausgabe:</b>&#160;&#160;<xsl:value-of select="//xdf3:xdatenfelder.datenfeldgruppe.0103/xdf3:datenfeldgruppe/xdf3:hilfetextAusgabe"/><br/><br/>
						<b>Art:&#160;&#160;</b>
						<xsl:choose>
		...
		<xsl:choose>
			<xsl:when test="$Element/xdf3:enthaelt/*/name() = 'xdf3:datenfeld'">
				<xsl:if test="$Element/xdf3:enthaelt/*/xdf3:feldart != 'hidden' or $ZeigeVersteckte='1'">
					<xsl:element name="div">
						...
						<xsl:variable name="RichtigeVersion">
							<xsl:choose>
								<xsl:when test="not($Element/xdf3:enthaelt/*/xdf3:codelisteReferenz)">
								</xsl:when>
								<xsl:when test="not(fn:string($Element/xdf3:enthaelt/*/xdf3:codelisteReferenz/xdf3:version))">
									<xsl:variable name="CodelisteAbfrageURL" select="fn:concat($XMLXRepoOhneVersionPfadPrefix,$Element/xdf3:enthaelt/*/xdf3:codelisteReferenz/xdf3:canonicalIdentification,$XMLXRepoOhneVersionPfadPostfix)"/>
				...
				LEER
								...
								<xsl:otherwise><xsl:value-of select="$Element/xdf3:enthaelt/*/xdf3:codelisteReferenz/xdf3:version"/></xsl:otherwise>
							</xsl:choose>
						</xsl:variable>
						...
						<xsl:variable name="CodelisteURL" select="fn:concat($XMLXRepoMitVersionPfadPrefix,$Element/xdf3:enthaelt/*/xdf3:codelisteReferenz/xdf3:canonicalIdentification,'_',$RichtigeVersion,$XMLXRepoMitVersionPfadPostfix)"/>
						
						<xsl:variable name="CodelisteInhalt">
							<xsl:choose>
								<xsl:when test="not($Element/xdf3:enthaelt/*/xdf3:codelisteReferenz)">
								</xsl:when>
								<xsl:when test="$CodelistenInhalt = '0'">
									<xsl:if test="$DebugMode = '4'">
										<xsl:message>
				NICHT LADEN: <xsl:value-of select="$CodelisteURL"/>
										</xsl:message>
									</xsl:if>
								</xsl:when>
								<xsl:when test="fn:doc-available($CodelisteURL)">
									...
									<xsl:if test="$DebugMode = '4'">
										<xsl:message>
				URL: <xsl:value-of select="$CodelisteURL"/>
										</xsl:message>
									</xsl:if>
								</xsl:when>
								<xsl:when test="fn:doc-available($CodelisteDatei)">
									...
									<xsl:if test="$DebugMode = '4'">
										<xsl:message>
				FILE: <xsl:value-of select="$CodelisteDatei"/>
										</xsl:message>
									</xsl:if>
								</xsl:when>
								<xsl:otherwise>
									<xsl:if test="$DebugMode = '4'">
										<xsl:message>
				LEER: url <xsl:value-of select="$CodelisteURL"/> - file <xsl:value-of select="$CodelisteDatei"/>
										</xsl:message>
									</xsl:if>
								</xsl:otherwise>
							</xsl:choose>
									...
									<xsl:element name="select">
										...
										<xsl:choose>
											...
											<xsl:when test="$Element/xdf3:enthaelt/*/xdf3:codelisteReferenz">
												...
												<xsl:choose>
													<xsl:when test="$CodelistenInhalt = '0'">
														<option value="001">Die Codeliste <xsl:value-of select="$Element/xdf3:enthaelt/*/xdf3:codelisteReferenz/xdf3:canonicalVersionUri"/> wurde nicht geladen.</option>
													...
													<xsl:when test="(fn:string-length($CodelisteInhalt) &lt; 10) and not(fn:string($Element/xdf3:enthaelt/*/xdf3:codelisteReferenz/xdf3:version)) and $AktuelleCodelisteLaden = '0'">
														<option value="001">Die Codeliste <xsl:value-of select="$Element/xdf3:enthaelt/*/xdf3:codelisteReferenz/xdf3:canonicalVersionUri"/> konnte nicht geladen werden, da keine Version angegeben ist.</option>
														<option value="002">Beispieleintrag A</option>
														<option value="003">Beispieleintrag B</option>
														<option value="004">Beispieleintrag C</option>
														<option value="005">Beispieleintrag D</option>
													</xsl:when>
													<xsl:when test="(fn:string-length($CodelisteInhalt) &lt; 10) and $AktuelleCodelisteLaden = '1'">
														<option value="001">Die Codeliste <xsl:value-of select="$Element/xdf3:enthaelt/*/xdf3:codelisteReferenz/xdf3:canonicalVersionUri"/> konnte nicht geladen werden.</option>
														<option value="002">Beispieleintrag A</option>
														<option value="003">Beispieleintrag B</option>
														<option value="004">Beispieleintrag C</option>
														<option value="005">Beispieleintrag D</option>
						...
						<span class="Bezeichnung">
							<xsl:if test="fn:not(empty($Element/xdf3:enthaelt/*/xdf3:hilfetextEingabe/text())) or ($Element/xdf3:enthaelt/*/xdf3:feldart = 'select' and fn:count($Element/xdf3:enthaelt/*/xdf3:werte/xdf3:wert) &gt; fn:number($MaxWerte) and fn:count($Element/xdf3:enthaelt/*/xdf3:werte/xdf3:wert/xdf3:hilfe) &gt; 0) or ($Element/xdf3:enthaelt/*/xdf3:codelisteReferenz and $Element/xdf3:enthaelt/*/xdf3:helpKey)">
								&#160;&#160;
								<div class="Hilfe" onclick="ZeigeBox(this)">?
									<div class="Popuptext">
										...
										<xsl:if test="fn:not(empty($Element/xdf3:enthaelt/*/xdf3:hilfetextEingabe/text())) and ($Element/xdf3:enthaelt/*/xdf3:feldart = 'select' and ((fn:count($Element/xdf3:enthaelt/*/xdf3:werte/xdf3:wert) &gt; fn:number($MaxWerte) and fn:count($Element/xdf3:enthaelt/*/xdf3:werte/xdf3:wert/xdf3:hilfe) &gt; 0) or ($Element/xdf3:enthaelt/*/xdf3:codelisteReferenz and $Element/xdf3:enthaelt/*/xdf3:helpKey)))">
											<br/><br/>
										</xsl:if>
										...
										<xsl:if test="$Element/xdf3:enthaelt/*/xdf3:feldart = 'select' and $Element/xdf3:enthaelt/*/xdf3:codelisteReferenz and $Element/xdf3:enthaelt/*/xdf3:helpKey and fn:string-length($CodelisteInhalt) &gt; 10">
											<b>Hilfe zu den Auswahlwerten der Codeliste:</b><br/>

											<xsl:variable name="NameCodeKey"><xsl:choose><xsl:when test="$Element/xdf3:enthaelt/*/xdf3:codeKey/text() !=''"><xsl:value-of select="$Element/xdf3:enthaelt/*/xdf3:codeKey"/></xsl:when><xsl:otherwise><xsl:value-of select="$CodelisteInhalt/*/gc:ColumnSet/gc:Key[1]/gc:ColumnRef/@Ref"/><xsl:value-of select="$CodelisteInhalt/*/ColumnSet/Key[1]/ColumnRef/@Ref"/></xsl:otherwise></xsl:choose></xsl:variable>
											<xsl:variable name="NameCodenameKey"><xsl:choose><xsl:when test="$Element/xdf3:enthaelt/*/xdf3:nameKey/text() !=''"><xsl:value-of select="$Element/xdf3:enthaelt/*/xdf3:nameKey"/></xsl:when><xsl:otherwise><xsl:value-of select="$CodelisteInhalt/*/gc:ColumnSet/(gc:Column[@Id != $NameCodeKey])[1]/@Id"/><xsl:value-of select="$CodelisteInhalt/*/ColumnSet/(Column[@Id != $NameCodeKey])[1]/@Id"/></xsl:otherwise></xsl:choose></xsl:variable>
											<xsl:variable name="NameHelpKey"><xsl:value-of select="$Element/xdf3:enthaelt/*/xdf3:helpKey"/></xsl:variable>
											...
											<table>
												<tbody>
													<xsl:for-each-group select="$CodelisteInhalt/*/*:SimpleCodeList/*:Row" group-by="*:Value[@ColumnRef=$NameCodenameKey]">
														<tr class="Auswahlistehilfe">
															<td class="Auswahlistehilfe"><xsl:value-of select="./*:Value[@ColumnRef=$NameCodenameKey]"/>&#160;&#160;&#160;</td>
															<td class="Auswahlistehilfe"><i><xsl:value-of select="./*:Value[@ColumnRef=$NameHelpKey]"/></i></td>
														</tr>
													</xsl:for-each-group>
												</tbody>
											</table>
						...
						<span class="Bezeichnung">
							...
							<xsl:if test="$Infobox = '1'">
								<xsl:variable name="Infoboxinhalt">
									...
									<b>Bezeichnung Ausgabe:</b>&#160;&#160;<xsl:value-of select="$Element/xdf3:enthaelt/*/xdf3:bezeichnungAusgabe"/><br/>
									<b>Hilfetext Ausgabe:</b>&#160;&#160;<xsl:value-of select="$Element/xdf3:enthaelt/*/xdf3:hilfetextAusgabe"/><br/><br/>
...
-->
		<style>
			...
			* html body 
			...
			tr:nth-child(odd).Auswahlistehilfe 
			{
				background-color: #dedeb1;
				border: thin solid;
			}
			tr:nth-child(even).Auswahlistehilfe 
			{
				background-color: #ffc;
				border: thin solid;
			}
