...
<xsl:stylesheet
	...
	<xsl:variable name="StyleSheetName" select="'COMP-DF_1_01_xdf3.xsl'"/> <!-- BackUp, falls fn:static-base-uri() leer -->
	...
	<xsl:param name="VergleichsGrad" select="'0'"/>
	<xsl:variable name="VergleichsGradZahl" select="fn:number($VergleichsGrad)"/>
	...
	<xsl:variable name="InputDateiURI" select="$DocumentURI"/>
	<xsl:variable name="InputDateinameOhnePfad" select="(tokenize($DocumentURI,'/'))[last()]"/>
	<xsl:variable name="InputPfad" select="fn:substring-before($DocumentURI, $InputDateinameOhnePfad)"/>
	<xsl:variable name="InputDateinameOhneExt" select="(tokenize($InputDateinameOhnePfad,'\.'))[1]"/>
	
	<xsl:variable name="Daten" select="/"/>
	
	<xsl:variable name="VergleichsDateiURI">
		<xsl:choose>
			<xsl:when test="matches($VergleichsDateiName, '^[a-zA-Z]:\\')">
				<xsl:value-of select="concat('file:/', replace($VergleichsDateiName, '\\', '/'))"/>
			</xsl:when>
			<xsl:otherwise>
				<xsl:value-of select="concat($InputPfad,replace($VergleichsDateiName, '\\', '/'))"/>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>

	<xsl:variable name="VergleichsDateinameOhnePfad" select="(tokenize($VergleichsDateiURI,'/'))[last()]"/>
	<xsl:variable name="VergleichsDateinameOhneExt" select="(tokenize($VergleichsDateinameOhnePfad,'\.'))[1]"/>

	<xsl:variable name="VergleichsDaten" select="document($VergleichsDateiURI)"/>
	...
	<xsl:template match="/">
		...
		<xsl:if test="$DebugMode = '1' or $DebugMode = '2' or $DebugMode = '3' or $DebugMode = '4'">
			<xsl:message>
				Start
				InputDatei: <xsl:value-of select="$InputDateinameOhnePfad"/>
				VergleichsDatei: <xsl:value-of select="$VergleichsDateinameOhnePfad"/>
			</xsl:message>
		</xsl:if>
		...
		<xsl:if test="$DebugMode = '4'">
			<xsl:message>
				...
				VergleichsGrad: <xsl:value-of select="$VergleichsGrad"/>
		...
		<xsl:choose>
			<xsl:when test="$DateiOutput ='1'">
				<xsl:variable name="DateiNamePraefix">Vergleich_<xsl:if test="$VergleichsGradZahl != 0">Grad<xsl:value-of select="$VergleichsGrad"/>_</xsl:if></xsl:variable>

				<xsl:variable name="OutputDateiname">
					<xsl:choose>
						<xsl:when test="name(/*) ='xdf3:xdatenfelder.stammdatenschema.0102'"><xsl:value-of select="$DateiNamePraefix"/><xsl:value-of select="$KurznameSDSA"/>_<xsl:value-of select="$KurznameSDSO"/>.html</xsl:when>
						<xsl:when test="name(/*) ='xdf3:xdatenfelder.datenfeldgruppe.0103'"><xsl:value-of select="$DateiNamePraefix"/><xsl:value-of select="$KurznameSDSA"/>_<xsl:value-of select="$KurznameSDSO"/>.html</xsl:when>
						<xsl:when test="name(/*) ='xdf3:xdatenfelder.dokumentsteckbrief.0101'"><xsl:value-of select="$DateiNamePraefix"/><xsl:value-of select="$KurznameSDSA"/>_<xsl:value-of select="$KurznameSDSO"/>.html</xsl:when>
				...
				<head>
					<xsl:choose>
						...
						<xsl:when test="name(/*) ='xdf3:xdatenfelder.dokumentsteckbrief.0101'">
							<title>Vergleich von Dokument <xsl:value-of select="$NameSDSA"/> mit Datenfeldgruppe <xsl:value-of select="$NameSDSO"/></title>
						</xsl:when>
							...
							<div id="Inhalt">
								<div id="Zusammenfassungsbereich">
									<xsl:if test="$AenderungsFazit = '1' and $JavaScript = '1'">
										...
										<p>
											<span id="AnzahlAenderungBaukasten"/>
											<span id="AnzahlNeuBaukasten"/>
											<span id="AnzahlGeloeschtBaukasten"/>
										</p>
										<p class="Zusammenfassung">Änderungen der Codelisten</p>
										<p>
											<span id="AnzahlAenderungCodelisten"/>
											<span id="AnzahlNeuCodelisten"/>
											<span id="AnzahlGeloeschtCodelisten"/>
										</p>
									</xsl:if>
								</div>
		...
		<xsl:if test="$DebugMode = '1' or $DebugMode = '2' or $DebugMode = '3' or $DebugMode = '4'">
			<xsl:message>
				++++ dokumentsteckbriefeinzeln ++++
					...
					<h2>
						<a name="StammDetails"/>Vergleich von Dokumentsteckbrief <xsl:value-of select="$NameSDSA"/> mit Dokumentsteckbrief <xsl:value-of select="$NameSDSO"/>
					</h2>
					<table style="page-break-after:always">
						<thead>
							<tr>
								<th width="10%">Metadatum</th>
								<th width="45%">Inhalt Dokumentsteckbrief <xsl:value-of select="$NameSDSA"/></th>
								<th width="45%">Inhalt Dokumentsteckbrief <xsl:value-of select="$NameSDSO"/></th>
							</tr>
						</thead>
						<tbody>
							...
							<xsl:call-template name="dokumentsteckbriefdetails">
								...
								<xsl:with-param name="VergleichsElement" select="$VergleichsDaten/*/xdf3:dokumentsteckbrief"/>
							</xsl:call-template>
		...
		<xsl:if test="$DebugMode = '3' or $DebugMode = '4'">
			<xsl:message>
				-------- <xsl:value-of select="$Element/xdf3:identifikation/xdf3:id"/><xsl:if test="$Element/xdf3:identifikation/xdf3:version">V<xsl:value-of select="$Element/xdf3:identifikation/xdf3:version"/></xsl:if> --------
										...
										<xsl:call-template name="definitionsdatenvergleich">
											<xsl:with-param name="Element" select="$Element"/>
											<xsl:with-param name="VergleichsElement" select="$VergleichsElement"/>
										</xsl:call-template>

										<tr>
											<td>Änderbarkeit Struktur <xsl:if test="$VergleichsGradZahl &lt; 2 and (fn:string($VergleichsElement/xdf3:ableitungsmodifikationenStruktur) != fn:string($Element/xdf3:ableitungsmodifikationenStruktur))">##</xsl:if></td>
											<td>
												<xsl:apply-templates select="$Element/xdf3:ableitungsmodifikationenStruktur"/>
											</td>
											<xsl:choose>
												<xsl:when test="$VergleichsGradZahl &gt; 1 or (fn:string($VergleichsElement/xdf3:ableitungsmodifikationenStruktur) = fn:string($Element/xdf3:ableitungsmodifikationenStruktur))">
													<td class="Gleich">
										...
										<tr>
											<td>Änderbarkeit Repräsentation <xsl:if test="$VergleichsGradZahl &lt; 2 and (fn:string($VergleichsElement/xdf3:ableitungsmodifikationenRepraesentation) != fn:string($Element/xdf3:ableitungsmodifikationenRepraesentation))">##</xsl:if></td>
											<td>
												<xsl:apply-templates select="$Element/xdf3:ableitungsmodifikationenRepraesentation"/>
											</td>
											<xsl:choose>
												<xsl:when test="$VergleichsGradZahl &gt; 1 or (fn:string($VergleichsElement/xdf3:ableitungsmodifikationenRepraesentation) = fn:string($Element/xdf3:ableitungsmodifikationenRepraesentation))">
													<td class="Gleich">
										...
										<tr>
											<td>Bezeichnung <xsl:if test="$VergleichsGradZahl &lt; 3 and (fn:string($VergleichsElement/xdf3:bezeichnung) != fn:string($Element/xdf3:bezeichnung))">##</xsl:if></td>
											<td>
												<xsl:value-of select="$Element/xdf3:bezeichnung"/>
											</td>
											<xsl:choose>
												<xsl:when test="$VergleichsGradZahl &gt; 2 or (fn:string($VergleichsElement/xdf3:bezeichnung) = fn:string($Element/xdf3:bezeichnung))">
													<td class="Gleich">
										...
										<tr>
											<td>Hilfetext <xsl:if test="$VergleichsGradZahl &lt; 3 and (fn:string($VergleichsElement/xdf3:hilfetext) != fn:string($Element/xdf3:hilfetext))">##</xsl:if></td>
											<td>
												<xsl:value-of select="fn:replace($Element/xdf3:hilfetext,'\n','&lt;br/&gt;')" disable-output-escaping="yes"/>
											</td>
											<xsl:choose>
												<xsl:when test="$VergleichsGradZahl &gt; 2 or (fn:string($VergleichsElement/xdf3:hilfetext) = fn:string($Element/xdf3:hilfetext))">
													<td class="Gleich">
										...
										<xsl:call-template name="zustandsdatenvergleich">
											<xsl:with-param name="Element" select="$Element"/>
											<xsl:with-param name="VergleichsElement" select="$VergleichsElement"/>
										</xsl:call-template>
										...
										<tr>
											<td><b>Dokumentsteckbrief</b> <xsl:if test="$VergleichsGradZahl &lt; 2 and (fn:string($VergleichsElement/xdf3:dokumentsteckbrief) != fn:string($Element/xdf3:dokumentsteckbrief))">##</xsl:if></td>
											<td>
											...
											<xsl:choose>
												<xsl:when test="$VergleichsGradZahl &gt; 1 or (fn:string($VergleichsElement/xdf3:dokumentsteckbrief) = fn:string($Element/xdf3:dokumentsteckbrief))">
													<td class="Gleich">
										...
										<xsl:call-template name="unterelementevergleich">
											<xsl:with-param name="Element" select="$Element"/>
											<xsl:with-param name="VergleichsElement" select="$VergleichsElement"/>
										</xsl:call-template>

										<xsl:call-template name="regeldatenvergleich">
											<xsl:with-param name="Element" select="$Element"/>
											<xsl:with-param name="VergleichsElement" select="$VergleichsElement"/>
										</xsl:call-template>

										<xsl:call-template name="relationenvergleich">
											<xsl:with-param name="Element" select="$Element"/>
											<xsl:with-param name="VergleichsElement" select="$VergleichsElement"/>
										</xsl:call-template>
		...
		<xsl:if test="$DebugMode = '3' or $DebugMode = '4'">
			<xsl:message>
				-------- <xsl:value-of select="$Element/xdf3:identifikation/xdf3:id"/><xsl:if test="$Element/xdf3:identifikation/xdf3:version">V<xsl:value-of select="$Element/xdf3:identifikation/xdf3:version"/></xsl:if> --------
										...
										<tr>
											<td>Strukturelementart <xsl:if test="$VergleichsGradZahl &lt; 2 and fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:schemaelementart) != fn:string($Element/xdf3:schemaelementart))">##</xsl:if></td>
											<td>
												<xsl:apply-templates select="$Element/xdf3:schemaelementart"/>
											</td>
											<xsl:choose>
												<xsl:when test="$VergleichsGradZahl &gt; 1 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:schemaelementart) = fn:string($Element/xdf3:schemaelementart))">
													<td class="Gleich">
										...
										<xsl:call-template name="nutzerdatenvergleich">
											<xsl:with-param name="Element" select="$Element"/>
											<xsl:with-param name="VergleichsElement" select="$VergleichsElement"/>
										</xsl:call-template>
		...
		<xsl:if test="$DebugMode = '3' or $DebugMode = '4'">
			<xsl:message>
				-------- <xsl:value-of select="$Element/xdf3:identifikation/xdf3:id"/><xsl:if test="$Element/xdf3:identifikation/xdf3:version">V<xsl:value-of select="$Element/xdf3:identifikation/xdf3:version"/></xsl:if> --------
										...
										<tr>
											<td>Art <xsl:if test="fn:string($VergleichsElement/xdf3:istAbstrakt) != fn:string($Element/xdf3:istAbstrakt)">##</xsl:if></td>
											<td>
												<xsl:apply-templates select="$Element/xdf3:istAbstrakt"/>
											</td>
											<xsl:choose>
												<xsl:when test="fn:string($VergleichsElement/xdf3:istAbstrakt) = fn:string($Element/xdf3:istAbstrakt)">
													<td class="Gleich">
														<xsl:apply-templates select="$VergleichsElement/xdf3:istAbstrakt"/>
													</td>
												</xsl:when>
												<xsl:otherwise>
													<td class="Ungleich">
										...
										<xsl:for-each select="$Element/xdf3:relation[xdf3:praedikat/code = 'VKN']">
											<xsl:variable name="elementid" select="./xdf3:objekt/xdf3:id"/>
											<xsl:variable name="VergleichsRelation" select="$VergleichsElement/xdf3:relation[xdf3:praedikat/code = 'VKN' and xdf3:objekt/xdf3:id = $elementid]"/>
											
											<tr>
												<xsl:choose>
													<xsl:when test="fn:position() = 1"><td>Zugeordnete Dokumentsteckbriefe</td></xsl:when>
												...
												<xsl:choose>
													...
													<xsl:when test="empty($VergleichsRelation)">
														<td class="Ungleich">
															<ul class="hangrun">
													...
													<xsl:otherwise>
														<td class="Gleich">
															<ul class="hangrun">
																<li>
																	<xsl:value-of select="$VergleichsRelation/xdf3:objekt/xdf3:id"/>
																</li>
															</ul>
														</td>
													</xsl:otherwise>
										...
										<xsl:for-each select="$VergleichsElement/xdf3:relation[xdf3:praedikat/code = 'VKN']">
											<xsl:variable name="elementid" select="./xdf3:objekt/xdf3:id"/>
											
											<xsl:if test="not($Element/xdf3:relation[xdf3:praedikat/code = 'VKN' and xdf3:objekt/xdf3:id = $elementid])">
												<tr>
													<xsl:choose>
														<xsl:when test="count($Element/xdf3:relation[xdf3:praedikat/code = 'VKN']) = 0 and fn:position() = 1"><td>Zugeordnete Dokumentsteckbriefe</td></xsl:when>
														<xsl:otherwise><td></td></xsl:otherwise>
													</xsl:choose>
													<td>
														<ul class="hangrun">
													...
													<xsl:choose>
														<xsl:when test="$VergleichsGradZahl &gt; 1">
															<td class="Gleich">
																<ul class="hangrun">
																	<li>
																		<xsl:value-of select="./xdf3:objekt/xdf3:id"/>
										...
										<tr>
											<td>Dokumentart <xsl:if test="fn:string($VergleichsElement/xdf3:dokumentart) != fn:string($Element/xdf3:dokumentart)">##</xsl:if></td>
											<td>
												<xsl:apply-templates select="$Element/xdf3:dokumentart"/>
											</td>
											<xsl:choose>
												<xsl:when test="fn:string($VergleichsElement/xdf3:dokumentart) = fn:string($Element/xdf3:dokumentart)">
													<td class="Gleich">
														<xsl:apply-templates select="$VergleichsElement/xdf3:dokumentart"/>
													</td>
												</xsl:when>
												<xsl:otherwise>
													<td class="Ungleich">
				...
				-------- <xsl:value-of select="$Element/xdf3:identifikation/xdf3:id"/><xsl:if test="$Element/xdf3:identifikation/xdf3:version">V<xsl:value-of select="$Element/xdf3:identifikation/xdf3:version"/></xsl:if> --------
									...
									<xsl:choose>
										<xsl:when test="$Element/name() = 'xdf3:datenfeld'">
											...
											<tr>
												<td>Feldart <xsl:if test="fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:schemaelementart) != fn:string($Element/xdf3:schemaelementart))">##</xsl:if></td>
												<td>
													<xsl:apply-templates select="$Element/xdf3:feldart"/>													
												</td>
												<xsl:choose>
													<xsl:when test="empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:schemaelementart) = fn:string($Element/xdf3:schemaelementart))">
														<td class="Gleich">
											...
											<tr>
												<td>Datentyp <xsl:if test="fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:datentyp) != fn:string($Element/xdf3:datentyp))">##</xsl:if></td>
												<td>
													<xsl:apply-templates select="$Element/xdf3:datentyp"/>
												</td>
												<xsl:choose>
													<xsl:when test="empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:datentyp) = fn:string($Element/xdf3:datentyp))">
														<td class="Gleich">
											...
											<tr>
												...
												<xsl:choose>
													<xsl:when test="empty($VergleichsElement) or (fn:concat($Element/xdf3:praezisierung/@minValue,'-',$Element/xdf3:praezisierung/@maxValue) = fn:concat($VergleichsElement/xdf3:praezisierung/@minValue,'-',$VergleichsElement/xdf3:praezisierung/@maxValue))">
														<td class="Gleich">
											...
											<tr>
												<td>Pattern <xsl:if test="fn:not(fn:empty($VergleichsElement)) and (fn:string($Element/xdf3:praezisierung/@pattern) != fn:string($VergleichsElement/xdf3:praezisierung/@pattern))">##</xsl:if></td>
												<td><xsl:value-of select="$Element/xdf3:praezisierung/@pattern"/></td>
												<xsl:choose>
													<xsl:when test="empty($VergleichsElement) or (fn:string($Element/xdf3:praezisierung/@pattern) = fn:string($VergleichsElement/xdf3:praezisierung/@pattern))">
														<td class="Gleich">
											...
											<xsl:if test="$Element/xdf3:werte or $VergleichsElement/xdf3:werte">
												<tr>
													<td>Werteliste</td>
													<td colspan="2">
														<table width="100%">
															<tbody>
																...
																<xsl:for-each select="$Element/xdf3:werte/xdf3:wert">
																	...
																	<tr>
																		...
																		<xsl:choose>
																			<xsl:when test="$VergleichsGradZahl &lt; 3 and fn:not(empty($VergleichsElement)) and fn:not(empty($VergleichsElement/xdf3:werte/xdf3:wert[./xdf3:code = $codeE])) and (fn:string($nameE) != fn:string($nameV))">
																		...
																		<xsl:choose>
																			<xsl:when test="$VergleichsGradZahl &lt; 3 and fn:not(empty($VergleichsElement)) and fn:not(empty($VergleichsElement/xdf3:werte/xdf3:wert[./xdf3:code = $codeE])) and (fn:string($hilfeE) != fn:string($hilfeV))">
																...
																<xsl:for-each select="$VergleichsElement/xdf3:werte/xdf3:wert">
																	<xsl:variable name="codeV" select="./xdf3:code"/>
																	<xsl:if test="fn:not($Element/xdf3:werte/xdf3:wert[./xdf3:code = $codeV])">
																		<tr>
																			<td colspan="3"><i>Nicht vorhanden</i></td>
																			<td class="Ungleich"><xsl:value-of select="./xdf3:code"/> ##</td>
																			<xsl:choose>
																				<xsl:when test="$VergleichsGradZahl &gt; 2">
																					<td class="Gleich"><xsl:value-of select="./xdf3:name"/></td>
																				</xsl:when>
																				<xsl:otherwise>
																					<td class="Ungleich"><xsl:value-of select="./xdf3:name"/></td>
																				</xsl:otherwise>
																			</xsl:choose>
																			<xsl:choose>
																				<xsl:when test="$VergleichsGradZahl &gt; 2">
																					<td class="Gleich"><xsl:value-of select="./xdf3:hilfe"/></td>
																				</xsl:when>
																				<xsl:otherwise>
																					<td class="Ungleich"><xsl:value-of select="./xdf3:hilfe"/></td>
																				</xsl:otherwise>
																			</xsl:choose>
																		</tr>
																	</xsl:if>
											...
											<xsl:if test="$Element/xdf3:codelisteReferenz or $VergleichsElement/xdf3:codelisteReferenz">
												<tr>
												...
												<tr>
													...
													<td colspan="2">
														<xsl:if test="$Element/xdf3:codeKey/text() !='' or $Element/xdf3:nameKey/text() !='' or $Element/xdf3:helpKey/text() !='' or $VergleichsElement/xdf3:codeKey/text() !='' or $VergleichsElement/xdf3:nameKey/text() !='' or $VergleichsElement/xdf3:helpKey/text() !=''">
															<table width="100%">
																<tbody>
																	<tr>
											...
											<tr>
												<td>Maximale Dateigröße <xsl:if test="fn:not(fn:empty($VergleichsElement)) and (fn:string($Element/xdf3:maxSize) != string($VergleichsElement/xdf3:maxSize))">##</xsl:if></td>
												<xsl:choose>
											...
											<tr>
												<td>Vorbefüllung <xsl:if test="$VergleichsGradZahl &lt; 2 and fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:vorbefuellung) != fn:string($Element/xdf3:vorbefuellung))">##</xsl:if></td>
												<td>
													<xsl:apply-templates select="$Element/xdf3:vorbefuellung"/>
												</td>
												<xsl:choose>
													<xsl:when test="$VergleichsGradZahl &gt; 1 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:vorbefuellung) = fn:string($Element/xdf3:vorbefuellung))">
														<td class="Gleich">
											...
											<tr>
												<td>Inhalt <xsl:if test="fn:not(fn:empty($VergleichsElement)) and (fn:string($Element/xdf3:inhalt) != string($VergleichsElement/xdf3:inhalt))">##</xsl:if></td>
												<td>
													<xsl:value-of select="fn:replace($Element/xdf3:inhalt,'\n','&lt;br/&gt;')" disable-output-escaping="yes"/>
												</td>
												<xsl:choose>
													<xsl:when test="empty($VergleichsElement) or (fn:string($Element/xdf3:inhalt) = string($VergleichsElement/xdf3:inhalt))">
														<td class="Gleich">
											...
											<xsl:call-template name="verwendungsvergleich">
												<xsl:with-param name="Element" select="$Element"/>
												<xsl:with-param name="VergleichsElement" select="$VergleichsElement"/>
											</xsl:call-template>
										...
										<xsl:when test="$Element/name() = 'xdf3:datenfeldgruppe'">
											...
											<tr>
												<td>Gruppenart <xsl:if test="fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:art) != fn:string($Element/xdf3:art))">##</xsl:if></td>
												<td>
													<xsl:apply-templates select="$Element/xdf3:art"/>
												</td>
												<xsl:choose>
													<xsl:when test="empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:art) = fn:string($Element/xdf3:art))">
														<td class="Gleich">
															<xsl:apply-templates select="$VergleichsElement/xdf3:art"/>
														</td>
													</xsl:when>
	...
	<xsl:template name="stichwoertervergleich">
		<xsl:param name="Element"/>
		<xsl:param name="VergleichsElement"/>
										...
										<xsl:for-each select="$Element/xdf3:stichwort">
											...
											<tr>
												...
												<xsl:choose>
													...
													<xsl:when test="$VergleichsGradZahl &gt; 1 or empty($VergleichsStichwort)">
														<td class="Gleich">
															<ul class="hangrun">
																<li><i>Nicht vorhanden</i></li>
															</ul>
													...
													<xsl:when test="$VergleichsGradZahl &lt; 2 and ($uri != $VergleichsURI)">
														<td class="Ungleich">
															<ul class="hangrun">
																<li>
	...
	<xsl:template name="handlungsgrundlagenvergleich">
		<xsl:param name="Element"/>
		<xsl:param name="VergleichsElement"/>
										...
										<xsl:for-each select="$Element/xdf3:bezug">
											...
											<tr>
												...
												<xsl:choose>
													...
													<xsl:when test="$VergleichsGradZahl &gt; 1 and empty($VergleichsBezug)">
														<td class="Gleich">
															<ul class="hangrun">
																<li><i>Nicht vorhanden</i></li>
															</ul>
													...
													<xsl:when test="$VergleichsGradZahl &lt; 2 and empty($VergleichsBezug)">
														<td class="Ungleich">
															<ul class="hangrun">
																<li><i>Nicht vorhanden</i> ##</li>
															</ul>
													...
													<xsl:when test="$VergleichsGradZahl &gt; 1 and $link != $VergleichsLink">
														<td class="Gleich">
															<ul class="hangrun">
																<li>
													...
													<xsl:when test="$VergleichsGradZahl &lt; 2 and $link != $VergleichsLink">
														<td class="Ungleich">
															<ul class="hangrun">
																<li>
																	<xsl:value-of select="$VergleichsElement/xdf3:bezug[./text() = $bezug]/text()"/>
	...
	<xsl:template name="zustandsdatenvergleich">
		<xsl:param name="Element"/>
		<xsl:param name="VergleichsElement"/>


											<tr>
												<td>Gültig ab <xsl:if test="$VergleichsGradZahl &lt; 2 and fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:gueltigAb) != fn:string($Element/xdf3:gueltigAb))">##</xsl:if></td>
												<td>
													<xsl:value-of select="fn:format-date($Element/xdf3:gueltigAb,'[D01].[M01].[Y0001]')"/>
												</td>
												<xsl:choose>
													<xsl:when test="$VergleichsGradZahl &gt; 1 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:gueltigAb) = fn:string($Element/xdf3:gueltigAb))">
														<td class="Gleich">
											...
											<tr>
												<td>Gültig bis <xsl:if test="$VergleichsGradZahl &lt; 2 and fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:gueltigBis) != fn:string($Element/xdf3:gueltigBis))">##</xsl:if></td>
												<td>
													<xsl:value-of select="fn:format-date($Element/xdf3:gueltigBis,'[D01].[M01].[Y0001]')"/>
												</td>
												<xsl:choose>
													<xsl:when test="$VergleichsGradZahl &gt; 1 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:gueltigBis) = fn:string($Element/xdf3:gueltigBis))">
														<td class="Gleich">
											...
											<tr>
												<td>Fachlicher Ersteller <xsl:if test="$VergleichsGradZahl = 0 and fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:statusGesetztDurch) != fn:string($Element/xdf3:statusGesetztDurch))">##</xsl:if></td>
												<td>
													<xsl:value-of select="$Element/xdf3:statusGesetztDurch"/>
												</td>
												<xsl:choose>
													<xsl:when test="$VergleichsGradZahl &gt; 0 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:statusGesetztDurch) = fn:string($Element/xdf3:statusGesetztDurch))">
														<td class="Gleich">
											...
											<tr>
												<td>Status <xsl:if test="$VergleichsGradZahl = 0 and fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:freigabestatus) != fn:string($Element/xdf3:freigabestatus))">##</xsl:if></td>
												<td>
													<xsl:apply-templates select="$Element/xdf3:freigabestatus"/>
												</td>
												<xsl:choose>
													<xsl:when test="$VergleichsGradZahl &gt; 0 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:freigabestatus) = fn:string($Element/xdf3:freigabestatus))">
														<td class="Gleich">
											...
											<tr>
												<td>Status gesetzt am <xsl:if test="$VergleichsGradZahl = 0 and fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:statusGesetztAm) != fn:string($Element/xdf3:statusGesetztAm))">##</xsl:if></td>
												<td>
													<xsl:value-of select="fn:format-date($Element/xdf3:statusGesetztAm,'[D01].[M01].[Y0001]')"/>
												</td>
												<xsl:choose>
													<xsl:when test="$VergleichsGradZahl &gt; 0 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:statusGesetztAm) = fn:string($Element/xdf3:statusGesetztAm))">
														<td class="Gleich">
											...
											<tr>
												<td>Veröffentlichungsdatum <xsl:if test="$VergleichsGradZahl = 0 and fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:veroeffentlichungsdatum) != fn:string($Element/xdf3:veroeffentlichungsdatum))">##</xsl:if></td>
												<td>
													<xsl:value-of select="fn:format-date($Element/xdf3:veroeffentlichungsdatum,'[D01].[M01].[Y0001]')"/>
												</td>
												<xsl:choose>
													<xsl:when test="$VergleichsGradZahl &gt; 0 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:veroeffentlichungsdatum) = fn:string($Element/xdf3:veroeffentlichungsdatum))">
														<td class="Gleich">
											...
											<tr>
												<td>Letzte Änderung <xsl:if test="$VergleichsGradZahl = 0 and fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:letzteAenderung) != fn:string($Element/xdf3:letzteAenderung))">##</xsl:if></td>
												<td>
													<xsl:value-of select="fn:format-dateTime($Element/xdf3:letzteAenderung,'[D01].[M01].[Y0001] um [H01]:[m01] Uhr')"/>
												</td>
												<xsl:choose>
													<xsl:when test="$VergleichsGradZahl &gt; 0 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:letzteAenderung) = fn:string($Element/xdf3:letzteAenderung))">
														<td class="Gleich">
	...
	<xsl:template name="definitionsdatenvergleich">
		<xsl:param name="Element"/>
		<xsl:param name="VergleichsElement"/>
											...
											<tr>
												<td>Version <xsl:if test="$VergleichsGradZahl = 0 and fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:identifikation/xdf3:version) != fn:string($Element/xdf3:identifikation/xdf3:version))">##</xsl:if></td>
												<td>
													<xsl:value-of select="$Element/xdf3:identifikation/xdf3:version"/>
												</td>
												<xsl:choose>
													<xsl:when test="$VergleichsGradZahl &gt; 0 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:identifikation/xdf3:version) = fn:string($Element/xdf3:identifikation/xdf3:version))">
														<td class="Gleich">
											...
											<tr>
												<td>Versionshinweis <xsl:if test="$VergleichsGradZahl = 0 and fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:versionshinweis) != fn:string($Element/xdf3:versionshinweis))">##</xsl:if></td>
												<td>
													<xsl:value-of select="fn:replace($Element/xdf3:versionshinweis,'\n','&lt;br/&gt;')" disable-output-escaping="yes"/>
												</td>
												<xsl:choose>
													<xsl:when test="$VergleichsGradZahl &gt; 0 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:versionshinweis) = fn:string($Element/xdf3:versionshinweis))">
														<td class="Gleich">
											...
											<tr>
												<td>Name <xsl:if test="$VergleichsGradZahl = 0 and fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:name) != fn:string($Element/xdf3:name))">##</xsl:if></td>
												<td class="ElementName">
													<xsl:value-of select="$Element/xdf3:name"/>
												</td>
												<xsl:choose>
													<xsl:when test="$VergleichsGradZahl &gt; 0 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:name) = fn:string($Element/xdf3:name))">
...
<!-- HIER -->
											<xsl:call-template name="stichwoertervergleich">
												<xsl:with-param name="Element" select="$Element"/>
												<xsl:with-param name="VergleichsElement" select="$VergleichsElement"/>
											</xsl:call-template>

											<tr>
												<td>Definition <xsl:if test="$VergleichsGradZahl &lt; 2 and fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:definition) != fn:string($Element/xdf3:definition))">##</xsl:if></td>
												<td>
													<xsl:value-of select="fn:replace($Element/xdf3:definition,'\n','&lt;br/&gt;')" disable-output-escaping="yes"/>
												</td>
												<xsl:choose>
													<xsl:when test="$VergleichsGradZahl &gt; 1 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:definition) = fn:string($Element/xdf3:definition))">
														<td class="Gleich">
...
<!-- HIER -->
											<xsl:call-template name="handlungsgrundlagenvergleich">
												<xsl:with-param name="Element" select="$Element"/>
												<xsl:with-param name="VergleichsElement" select="$VergleichsElement"/>
											</xsl:call-template>
	
											<tr>
												<td>Beschreibung <xsl:if test="$VergleichsGradZahl &lt; 2 and fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:beschreibung) != fn:string($Element/xdf3:beschreibung))">##</xsl:if></td>
												<td>
													<xsl:value-of select="fn:replace($Element/xdf3:beschreibung,'\n','&lt;br/&gt;')" disable-output-escaping="yes"/>
												</td>
												<xsl:choose>
													<xsl:when test="$VergleichsGradZahl &gt; 1 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:beschreibung) = fn:string($Element/xdf3:beschreibung))">
														<td class="Gleich">
	...
	<xsl:template name="nutzerdatenvergleich">
		<xsl:param name="Element"/>
		<xsl:param name="VergleichsElement"/>

											<tr>
												<td>Bezeichnung Eingabe <xsl:if test="$VergleichsGradZahl &lt; 3 and fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:bezeichnungEingabe) != fn:string($Element/xdf3:bezeichnungEingabe))">##</xsl:if></td>
												<td>
													<xsl:value-of select="$Element/xdf3:bezeichnungEingabe"/>
												</td>
												<xsl:choose>
													<xsl:when test="$VergleichsGradZahl &gt; 2 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:bezeichnungEingabe) = fn:string($Element/xdf3:bezeichnungEingabe))">
														<td class="Gleich">
											...
											<tr>
												<td>Bezeichnung Ausgabe <xsl:if test="$VergleichsGradZahl &lt; 3 and fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:bezeichnungAusgabe) != fn:string($Element/xdf3:bezeichnungAusgabe))">##</xsl:if></td>
												<td>
													<xsl:value-of select="$Element/xdf3:bezeichnungAusgabe"/>
												</td>
												<xsl:choose>
													<xsl:when test="$VergleichsGradZahl &gt; 2 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:bezeichnungAusgabe) = fn:string($Element/xdf3:bezeichnungAusgabe))">
														<td class="Gleich">
											...
											<tr>
												<td>Hilfetext Eingabe <xsl:if test="$VergleichsGradZahl &lt; 3 and fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:hilfetextEingabe) != fn:string($Element/xdf3:hilfetextEingabe))">##</xsl:if></td>
												<td>
													<xsl:value-of select="fn:replace($Element/xdf3:hilfetextEingabe,'\n','&lt;br/&gt;')" disable-output-escaping="yes"/>
												</td>
												<xsl:choose>
													<xsl:when test="$VergleichsGradZahl &gt; 2 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:hilfetextEingabe) = fn:string($Element/xdf3:hilfetextEingabe))">
														<td class="Gleich">
											...
											<tr>
												<td>Hilfetext Ausgabe <xsl:if test="$VergleichsGradZahl &lt; 3 and fn:not(fn:empty($VergleichsElement)) and (fn:string($VergleichsElement/xdf3:hilfetextAusgabe) != fn:string($Element/xdf3:hilfetextAusgabe))">##</xsl:if></td>
												<td>
													<xsl:value-of select="fn:replace($Element/xdf3:hilfetextAusgabe,'\n','&lt;br/&gt;')" disable-output-escaping="yes"/>
												</td>
												<xsl:choose>
													<xsl:when test="$VergleichsGradZahl &gt; 2 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:hilfetextAusgabe) = fn:string($Element/xdf3:hilfetextAusgabe))">
														<td class="Gleich">
	...
	<xsl:template name="regeldatenvergleich">
		<xsl:param name="Element"/>
		<xsl:param name="VergleichsElement"/>
																	...
																	<tr>
																		...
																		<xsl:choose>
																			...
																			<xsl:otherwise>
																				...
																				<xsl:choose>
																					<xsl:when test="$VergleichsGradZahl &gt; 0 or empty($UnterelementO) or (fn:string($UnterelementO/xdf3:identifikation/xdf3:version) = fn:string($UnterelementA/xdf3:identifikation/xdf3:version))">
																						<td class="Gleich">
																							<xsl:value-of select="$UnterelementO/xdf3:identifikation/xdf3:version"/> 																						</td>
																					</xsl:when> 
																					<xsl:otherwise>
																						<td class="Ungleich">
																				...
																				<xsl:choose>
																					<xsl:when test="$VergleichsGradZahl &gt; 0 or empty($UnterelementO) or (fn:string($UnterelementO/xdf3:name) = fn:string($UnterelementA/xdf3:name))">
																						<td class="Gleich">
																				...
																				<xsl:choose>
																					<xsl:when test="empty($UnterelementO) or (fn:string($UnterelementO/xdf3:freitextRegel) = fn:string($UnterelementA/xdf3:freitextRegel))">
																						<td class="Gleich">
	...
	<xsl:template name="relationenvergleich">
		<xsl:param name="Element"/>
		<xsl:param name="VergleichsElement"/>

											<xsl:if test="count($Element/xdf3:relation[xdf3:praedikat/code != 'VKN']) or count($VergleichsElement/xdf3:relation[xdf3:praedikat/code != 'VKN'])">
												<tr>
													<td>
														<b>Relationen</b>
													</td>
														...
														<table width="100%">
															<thead>
																<tr>
																	...
																	<th width="26%">Art der Relation</th>
																	<xsl:choose>
																		<xsl:when test="empty($VergleichsElement)">
																			<th width="12%"></th>
																			<th width="12%"></th>
															...
															<tbody>
																<xsl:for-each select="$Element/xdf3:relation[xdf3:praedikat/code != 'VKN']">
																	...
																	<xsl:variable name="RelationA" select="."/>
																	<xsl:variable name="RelationO" select="$VergleichsElement/xdf3:relation[xdf3:objekt/xdf3:id = $RelationA/xdf3:objekt/xdf3:id]"/>
																	...
																	<tr>
																		...
																		<xsl:choose>
																			...
																			<xsl:when test="$VergleichsGradZahl &gt; 1 and empty($RelationO)">
																				<td colspan="4" class="Gleich">
																					<i>Nicht vorhanden</i>
																				</td>
																			</xsl:when>
																			<xsl:when test="empty($RelationO)">
																				<td colspan="4" class="Ungleich">
																					<i>Nicht vorhanden</i> ##
																				</td>
																			</xsl:when>
																			<xsl:otherwise>
																				<td>
																					<xsl:value-of select="$RelationO/xdf3:objekt/xdf3:id"/>
																					<xsl:if test="$ToolAufruf = '1'">
																						&#160;&#160;
																						<xsl:element name="a">
																							<xsl:attribute name="href"><xsl:value-of select="$ToolPfadPrefix"/><xsl:value-of select="$RelationO/xdf3:objekt/xdf3:id"/><xsl:if test="$RelationO/xdf3:objekt/xdf3:version">V<xsl:value-of select="$RelationO/xdf3:objekt/xdf3:version"/></xsl:if><xsl:value-of select="$ToolPfadPostfix"/></xsl:attribute>
																							<xsl:attribute name="target">FIMTool</xsl:attribute>
																							<xsl:attribute name="title">Springe in den Datenfeldeditor (man muss vorher angemeldet sein).</xsl:attribute>
																							&#8658;
																						</xsl:element>
																				...
																				<xsl:choose>
																					<xsl:when test="$VergleichsGradZahl &gt; 0 or empty($RelationO) or (fn:string($RelationO/xdf3:objekt/xdf3:version) = fn:string($RelationA/xdf3:objekt/xdf3:version))">
																						<td class="Gleich">
																							<xsl:value-of select="$RelationO/xdf3:objekt/xdf3:version"/> 																						</td>
																					</xsl:when> 
																					<xsl:otherwise>
																						<td class="Ungleich">
																							<xsl:value-of select="$RelationO/xdf3:objekt/xdf3:version"/> ##
																						</td>
																					</xsl:otherwise>
																				</xsl:choose>
																				<xsl:choose>
																					<xsl:when test="$VergleichsGradZahl &gt; 1 or empty($RelationO) or (fn:string($RelationO/xdf3:praedikat) = fn:string($RelationA/xdf3:praedikat))">
																						<td class="Gleich">
																							<xsl:apply-templates select="$RelationO/xdf3:praedikat"/>
																						</td>
																					</xsl:when>
																					<xsl:otherwise>
																						<td class="Ungleich">
																...
																<xsl:for-each select="$VergleichsElement/xdf3:relation[xdf3:praedikat/code != 'VKN']">
																	<xsl:variable name="RelationO" select="."/>
																	<xsl:variable name="RelationA" select="$Element/xdf3:relation[xdf3:objekt/xdf3:id = $RelationO/xdf3:objekt/xdf3:id]"/>
																	<xsl:choose>
																		<xsl:when test="empty($RelationA)">
																			<tr>
																				<td colspan="3"><i>Nicht vorhanden</i></td>
																				<xsl:choose>
																					<xsl:when test="$VergleichsGradZahl &gt; 1">
	...
	<xsl:template name="unterelementevergleich">
		<xsl:param name="Element"/>
		<xsl:param name="VergleichsElement"/>
																...
																<tbody>
																		...
																		<tr>
																			...
																			<xsl:choose>
																				...
																				<xsl:otherwise>
																					...
																					<xsl:choose>
																						<xsl:when test="$VergleichsGradZahl &gt; 0 or fn:string($UnterelementO/xdf3:enthaelt/*/xdf3:identifikation/xdf3:version) = fn:string($UnterelementA/xdf3:enthaelt/*/xdf3:identifikation/xdf3:version)">
																							<td class="Gleich">
																					...
																					<xsl:choose>
																						<xsl:when test="$VergleichsGradZahl &gt; 0 or (fn:string($UnterelementO/xdf3:enthaelt/*/xdf3:name) = fn:string($UnterelementA/xdf3:enthaelt/*/xdf3:name))">
																							<td class="Gleich">
																					...
																					<xsl:choose>
																						<xsl:when test="fn:string($UnterelementO/xdf3:anzahl) = fn:string($UnterelementA/xdf3:anzahl)">
																							<td class="Gleich">
																					...
																					<xsl:choose>
																						<xsl:when test="$VergleichsGradZahl &gt; 1 or $BezugA = $BezugO">
																							<td class="Gleich">
																	...
																	<xsl:for-each select="$VergleichsElement/xdf3:struktur">
																		...
																		<xsl:choose>
																			<xsl:when test="empty($UnterelementA)">
																				<tr>
																					<td colspan="5"><i>Nicht vorhanden</i></td>
																					<td class="Ungleich">
																						<xsl:element name="a">
																							<xsl:attribute name="href">#X<xsl:value-of select="$UnterelementO/xdf3:enthaelt/*/xdf3:identifikation/xdf3:id"/><xsl:if test="$UnterelementO/xdf3:enthaelt/*/xdf3:identifikation/xdf3:version">V<xsl:value-of select="$UnterelementO/xdf3:enthaelt/*/xdf3:identifikation/xdf3:version"/></xsl:if></xsl:attribute>
																							<xsl:value-of select="$UnterelementO/xdf3:enthaelt/*/xdf3:identifikation/xdf3:id"/>
	...
	<xsl:template name="verwendungsvergleich">
		<xsl:param name="Element"/>
		<xsl:param name="VergleichsElement"/>
											...
											<tr>
												...
												<xsl:variable name="BaukastenelementID" select="$Element/xdf3:identifikation/xdf3:id"/>
												<xsl:variable name="BaukastenelementVersion" select="$Element/xdf3:identifikation/xdf3:version"/>
													...
													<table width="100%">
														...
														<xsl:choose>
															<xsl:when test="not($Element/xdf3:identifikation/xdf3:version)">
																	...
																	<xsl:for-each-group select="//xdf3:datenfeldgruppe[xdf3:struktur/xdf3:enthaelt/*/xdf3:identifikation/xdf3:id = $BaukastenelementID]" group-by="xdf3:identifikation/xdf3:id">
																		<xsl:sort select="./xdf3:identifikation/xdf3:id"/>
																	...
																	<xsl:for-each-group select="//xdf3:stammdatenschema[xdf3:struktur/xdf3:enthaelt/*/xdf3:identifikation/xdf3:id = $BaukastenelementID]" group-by="xdf3:identifikation/xdf3:id">
																		<xsl:sort select="./xdf3:identifikation/xdf3:id"/>
															...
															<xsl:otherwise>
																	<xsl:for-each-group select="//xdf3:datenfeldgruppe[xdf3:struktur/xdf3:enthaelt/*/xdf3:identifikation/xdf3:id = $BaukastenelementID and xdf3:struktur/xdf3:enthaelt/*/xdf3:identifikation/xdf3:version = $BaukastenelementVersion]" group-by="xdf3:identifikation/xdf3:id">
																		<xsl:sort select="./xdf3:identifikation/xdf3:id"/>
																	...
																	<xsl:for-each-group select="//xdf3:stammdatenschema[xdf3:struktur/xdf3:enthaelt/*/xdf3:identifikation/xdf3:id = $BaukastenelementID and xdf3:struktur/xdf3:enthaelt/*/xdf3:identifikation/xdf3:version = $BaukastenelementVersion]" group-by="./xdf3:identifikation/xdf3:id">
																		<xsl:sort select="./xdf3:identifikation/xdf3:id"/>
...
<!-- HIER -->
								...
								<tr>
									<td>Letzte Änderung <xsl:if test="$VergleichsGradZahl = 0 and (fn:not(empty($VergleichsElement)) and fn:not((empty($Element/xdf3:letzteAenderung) and empty($VergleichsElement/xdf3:letzteAenderung)) or ($Element/xdf3:letzteAenderung = $VergleichsElement/xdf3:letzteAenderung)))">##</xsl:if></td>
									<td>
										<xsl:value-of select="fn:format-dateTime($Element/xdf3:letzteAenderung,'[D01].[M01].[Y0001] um [H01]:[m01] Uhr')"/>
									</td>
									<xsl:choose>
										<xsl:when test="$VergleichsGradZahl &gt; 0 or (empty($VergleichsElement) or (empty($Element/xdf3:letzteAenderung) and empty($VergleichsElement/xdf3:letzteAenderung)) or ($Element/xdf3:letzteAenderung = $VergleichsElement/xdf3:letzteAenderung))">
											<td class="Gleich">
												<xsl:value-of select="fn:format-dateTime($VergleichsElement/xdf3:letzteAenderung,'[D01].[M01].[Y0001] um [H01]:[m01] Uhr')"/>
											</td>
										</xsl:when>
	...
	<xsl:template name="codelistedetails">
		...
		<tr>
			<td>
				...
				Kennung <xsl:if test="empty($VergleichsElement)">##</xsl:if>
			</td>
			<td>
			...
			<xsl:choose>
				...
				<xsl:when test="fn:string($Element/xdf3:version) != fn:string($VergleichsElement/xdf3:version)">
		...
		<tr>
			<xsl:choose>
				<xsl:when test="$VergleichsGradZahl &gt; 0 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:version) = fn:string($Element/xdf3:version))">
					<td>Version</td>
					<td>
						<xsl:choose>
					...
					<td class="Gleich">
						<xsl:choose>
							<xsl:when test="not(empty($VergleichsElement)) and not(fn:string($VergleichsElement/xdf3:version))">
								Da die Version der Codeliste nicht vorgegeben ist, sollte in der Regel immer die aktuellste Version 
								<xsl:if test="$RichtigeVersion != 'unbestimmt'">
									(derzeit <xsl:value-of select="$RichtigeVersion"/>
									<xsl:if test="$XRepoAufruf = '1'">
										<xsl:element name="a"><xsl:attribute name="href"><xsl:value-of select="fn:concat($DocXRepoMitVersionPfadPrefix,$VergleichsElement/xdf3:canonicalIdentification,'_',$RichtigeVersion,$DocXRepoMitVersionPfadPostfix)"/></xsl:attribute><xsl:attribute name="target">XRepo</xsl:attribute><xsl:attribute name="title">Springe in das XRepository.</xsl:attribute>&#8658;</xsl:element>
									</xsl:if>) 
								</xsl:if>
								der Codeliste verwendet werden.
							</xsl:when>
		...
		<tr>
			<xsl:choose>
				<xsl:when test="$VergleichsGradZahl &gt; 0 or empty($VergleichsElement) or (fn:string($VergleichsElement/xdf3:canonicalVersionUri) = fn:string($Element/xdf3:canonicalVersionUri))">
					<td>Versionskennung</td>
					<td>
						<xsl:value-of select="$Element/xdf3:canonicalVersionUri"/>
					</td>
		...
		<xsl:if test="$CodelistenInhalt = '1'">
			...
			<xsl:variable name="XMLCodelisteURLV">
				<xsl:choose>
					<xsl:when test="fn:string($VergleichsElement/xdf3:version)">
			...
			<xsl:choose>
				...
				<xsl:when test="fn:not(fn:empty($VergleichsElement)) and fn:string-length($CodelisteInhaltV) &lt; 10">
					<tr>
						...
						<td>
							<b>
								<xsl:value-of select="$CodelisteInhaltE/*/*:Identification/*:ShortName"/>
							</b>
						</td>
						<td></td>
					</tr>
					<tr>
						<td>Langname</td>
						<td>
							<xsl:value-of select="$CodelisteInhaltE/*/*:Identification/*:LongName"/>
						</td>
						<td></td>
					</tr>
					<tr>
						<td>Herausgeber</td>
						<td>
							<xsl:value-of select="$CodelisteInhaltE/*/*:Identification/*:Agency/*:LongName"/>
						</td>
						<td></td>
					</tr>
					<tr>
				...
				<xsl:otherwise>
					<tr>
						<xsl:choose>
							<xsl:when test="$VergleichsGradZahl &gt; 0 or empty($VergleichsElement) or (fn:string($CodelisteInhaltV/*/*:Identification/*:ShortName) = fn:string($CodelisteInhaltE/*/*:Identification/*:ShortName))">
								<td>Kurzname</td>
								<td>
									<b><xsl:value-of select="$CodelisteInhaltE/*/*:Identification/*:ShortName"/></b>
								</td>
								<td class="Gleich">
									<b><xsl:value-of select="$CodelisteInhaltV/*/*:Identification/*:ShortName"/></b>
								</td>
							</xsl:when>
							<xsl:otherwise>
								<td>Kurzname ##</td>
					...
					<tr>
						<xsl:choose>
							<xsl:when test="$VergleichsGradZahl &gt; 0 or empty($VergleichsElement) or (fn:string($CodelisteInhaltV/*/*:Identification/*:LongName) = fn:string($CodelisteInhaltE/*/*:Identification/*:LongName))">
								<td>Langname</td>
								<td>
									<xsl:value-of select="$CodelisteInhaltE/*/*:Identification/*:LongName"/>
								</td>
								<td class="Gleich">
									<xsl:value-of select="$CodelisteInhaltV/*/*:Identification/*:LongName"/>
								</td>
							</xsl:when>
							<xsl:otherwise>
								<td>Langname ##</td>
					...
					<tr>
						<xsl:choose>
							<xsl:when test="$VergleichsGradZahl &gt; 0 or empty($VergleichsElement) or (fn:string($CodelisteInhaltV/*/*:Identification/*:Agency/*:LongName) = fn:string($CodelisteInhaltE/*/*:Identification/*:Agency/*:LongName))">
								<td>Herausgeber</td>
								<td>
									<xsl:value-of select="$CodelisteInhaltE/*/*:Identification/*:Agency/*:LongName"/>
								</td>
								<td class="Gleich">
									<xsl:value-of select="$CodelisteInhaltV/*/*:Identification/*:Agency/*:LongName"/>
								</td>
							</xsl:when>
							<xsl:otherwise>
								<td>Herausgeber ##</td>
	...
	<xsl:template name="codelistedetailsvergleich">
		...
		<xsl:variable name="CodelisteURNV">
			<xsl:value-of select="$VergleichsElement/xdf3:canonicalIdentification"/><xsl:if test="fn:string($VergleichsElement/xdf3:version)">_<xsl:value-of select="$VergleichsElement/xdf3:version"/></xsl:if>
		</xsl:variable>

		<xsl:variable name="RichtigeVersion">
			<xsl:choose>
				<xsl:when test="not(fn:string($VergleichsElement/xdf3:version))">
					<xsl:variable name="CodelisteAbfrageURL" select="fn:concat($XMLXRepoOhneVersionPfadPrefix,$VergleichsElement/xdf3:canonicalIdentification,$XMLXRepoOhneVersionPfadPostfix)"/>
					<xsl:variable name="CodelisteAbfrageInhalt">
						<xsl:choose>
							<xsl:when test="fn:doc-available($CodelisteAbfrageURL)">
								<xsl:copy-of select="fn:document($CodelisteAbfrageURL)"/>
				...
				<xsl:otherwise><xsl:value-of select="$VergleichsElement/xdf3:codelisteReferenz/xdf3:version"/></xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
...
-->
			...
			<xsl:choose>
				<xsl:when test="fn:string-length($CodelisteInhaltV) &lt; 10">
					<tr>
						<td>Inhalt</td>
						<td class="Ungleich" colspan="2">
							Codeliste <xsl:value-of select="$VergleichsElement/xdf3:canonicalIdentification"/><xsl:if test="fn:string($VergleichsElement/xdf3:version)">_<xsl:value-of select="$VergleichsElement/xdf3:version"/></xsl:if> konnte nicht geöffnet werden.
						</td>
					</tr>
				</xsl:when>
				<xsl:otherwise>
					<tr>
						...
						<td>
							<b>
								<xsl:value-of select="$CodelisteInhaltV/*/*:Identification/*:ShortName"/>
							</b>
						</td>
					</tr>
					<tr>
									...
									<tr>
										<xsl:choose>
											<xsl:when test="$CodelisteInhalt/*/gc:ColumnSet/gc:Column[@Id = $NameKeySpalte]">
												<xsl:choose>
													<xsl:when test="not(fn:string($CodelisteInhaltVergleich))">
			...
			<xsl:message>
				++++++++++++++++ footer ++++++++++++++++
								...
								<p>
									...
									XML-Vergleich: <xsl:value-of select="$VergleichsDateinameOhnePfad"/>
								</p>
								<p class="SehrKlein">
									VergleichsGrad: <xsl:value-of select="$VergleichsGrad"/><br/>
									<xsl:if test="fn:not(name(/*) ='xdf3:xdatenfelder.dokumentsteckbrief.0101')">
										RegelDetails: <xsl:value-of select="$RegelDetails"/><br/>
										...
										AenderungsFazit: <xsl:value-of select="$AenderungsFazit"/><br/>
									</xsl:if>
	...
	<xsl:template match="xdf3:istAbstrakt">
		<xsl:choose>
			<xsl:when test=". = 'true'">
	...
	<xsl:template name="styleandscript">
		...
		<style type="text/css">
			...
			* html body 
			...
			<xsl:if test="$Navigation = '0' or name(/*) ='xdf3:xdatenfelder.dokumentsteckbrief.0101'">
				display:none;
			</xsl:if>
			  }
			  ...
			  #Inhalt {
			 <xsl:choose>
				<xsl:when test="$Navigation = '0' or name(/*) ='CodeList' or name(/*) ='gc:CodeList' or name(/*) ='xdf3:xdatenfelder.dokumentsteckbrief.0101'">
				margin-left: 0.5em; 
				</xsl:when>
				<xsl:otherwise>
				margin-left: 20em; 
			  ...
			  #FussStand {
			 <xsl:choose>
				<xsl:when test="$Navigation = '0' or name(/*) ='xdf3:xdatenfelder.dokumentsteckbrief.0101'">
				display:inline;
				</xsl:when>
				<xsl:otherwise>
				display:none;
	...
	<xsl:if test="$JavaScript = '1'">
		...
		<script type="text/javascript">
			...
			<xsl:if test="$AenderungsFazit = '1' and $JavaScript = '1'">
				...
				document.getElementById("AnzahlAenderungBaukasten").innerHTML = "Anzahl geänderter Baukastenelemente: " + AnzahlAenderungBaukasten + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>";
				<xsl:if test="$VergleichsGradZahl != 0">
					document.getElementById("AnzahlAenderungBaukasten").style.display='none';
				</xsl:if>

				const AnzahlNeuBaukasten = document.querySelectorAll('.NeuBaukasten').length;
				document.getElementById("AnzahlNeuBaukasten").innerHTML = "Anzahl neu hinzugefügter Baukastenelemente: " + AnzahlNeuBaukasten + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>";

				const AnzahlGeloeschtBaukasten = document.querySelectorAll('.GeloeschtBaukasten').length;
				document.getElementById("AnzahlGeloeschtBaukasten").innerHTML = "Anzahl gelöschter Baukastenelemente: " + AnzahlGeloeschtBaukasten + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>";

				const AnzahlAenderungCodelisten = document.querySelectorAll('.AenderungCodelisten').length;
				document.getElementById("AnzahlAenderungCodelisten").innerHTML = "Anzahl geänderter Codelisten: " + AnzahlAenderungCodelisten + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>";
				<xsl:if test="$VergleichsGradZahl != 0">
					document.getElementById("AnzahlAenderungCodelisten").style.display='none';
				</xsl:if>

				const AnzahlNeuCodelisten = document.querySelectorAll('.NeuCodelisten').length;
				document.getElementById("AnzahlNeuCodelisten").innerHTML = "Anzahl neu hinzugefügter Codelisten: " + AnzahlNeuCodelisten + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>";

				const AnzahlGeloeschtCodelisten = document.querySelectorAll('.GeloeschtCodelisten').length;
				document.getElementById("AnzahlGeloeschtCodelisten").innerHTML = "Anzahl gelöschter Codelisten: " + AnzahlGeloeschtCodelisten + "<xsl:text disable-output-escaping="yes">&lt;</xsl:text>br/<xsl:text disable-output-escaping="yes">&gt;</xsl:text>";
