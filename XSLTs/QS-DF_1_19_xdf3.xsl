...
<xsl:stylesheet 
	...
	<xsl:variable name="StyleSheetName" select="'QS-DF_1_19_xdf3.xsl'"/>
			...
			<xsl:otherwise>
				...
				<gc:CodeList xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/"
				   ...
				   <Identification>
					  ...
					  <CanonicalVersionUri>urn:xoev-de:fim-datenfelder:codeliste:xdfm_1.7intern</CanonicalVersionUri>
					  <Agency>
