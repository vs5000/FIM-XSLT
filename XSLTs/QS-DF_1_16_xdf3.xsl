...
<xsl:stylesheet 
	...
	<xsl:variable name="StyleSheetName" select="'QS-DF_1_16_xdf3.xsl'"/>
			...
			<xsl:otherwise>
				...
				<gc:CodeList xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/"
				   ...
				   <Identification>
					  ...
					  <Version>1.6intern</Version>
					  <CanonicalUri>urn:xoev-de:fim-datenfelder:codeliste:xdfm</CanonicalUri>
					  <CanonicalVersionUri>urn:xoev-de:fim-datenfelder:codeliste:xdfm_1.6intern</CanonicalVersionUri>
					  <Agency>
